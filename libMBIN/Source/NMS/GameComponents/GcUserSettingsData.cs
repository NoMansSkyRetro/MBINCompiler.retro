...
namespace libMBIN.NMS.GameComponents
{
    ...
    public class GcUserSettingsData : NMSTemplate
    {
        ...
        [NMS(Index = 11)]
        /* 0x39E8 */ public PlayerVoiceEnum PlayerVoice;
        // size: 0x4
        ...
        [NMS(Index = 23)]
        /* 0x39EC */ public PS4FixedFPSEnum PS4FixedFPS;
        [NMS(Index = 24)]
        /* 0x39F0 */ public float PS4FOVFoot;
        [NMS(Index = 25)]
        /* 0x39F4 */ public float PS4FOVShip;
        [NMS(Index = 6)]
        ...
        [NMS(Index = 10)]
        /* 0x3A08 */ public SuitVoiceEnum SuitVoice;
        // size: 0x4
