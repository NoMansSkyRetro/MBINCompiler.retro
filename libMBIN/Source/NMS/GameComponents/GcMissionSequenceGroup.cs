...
{
    [NMS(GUID = 0xE0EA642614C45F2B, NameHash = 0xF0FD370B)]
    public class GcMissionSequenceGroup : NMSTemplate
    {
        ...
        [NMS(Index = 11)]
        /* 0x294 */ public bool HasCategoryOverride;
        [NMS(Index = 13)]
        /* 0x295 */ public bool HasColourOverride;
        [NMS(Index = 21)]
        /* 0x296 */ public bool HideFromLogIfConditionsMet;
        [NMS(Index = 15)]
        /* 0x297 */ public bool PrefixTitle;
        [NMS(Index = 0)]
        /* 0x298 */ public bool Silent;
    }
}
