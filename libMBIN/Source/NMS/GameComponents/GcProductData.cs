...
{
    [NMS(GUID = 0xC08FA5DA7821C66B, NameHash = 0x5C7DD06F)]
    public class GcProductData : NMSTemplate
    {
        ...
        [NMS(Index = 32)]
        /* 0x19C */ public GcFossilCategory FossilCategory;
        [NMS(Index = 16)]
        /* 0x1A0 */ public GcLegality Legality;
        [NMS(Index = 9)]
        /* 0x1A4 */ public int Level;
        [NMS(Index = 29)]
        /* 0x1A8 */ public float NormalisedValueOffWorld;
        [NMS(Index = 28)]
        /* 0x1AC */ public float NormalisedValueOnWorld;
        [NMS(Index = 39)]
        /* 0x1B0 */ public GcScannerIconTypes PinObjectiveScannableType;
        [NMS(Index = 15)]
        /* 0x1B4 */ public GcRarity Rarity;
        [NMS(Index = 26)]
        /* 0x1B8 */ public int RecipeCost;
        [NMS(Index = 19)]
        /* 0x1BC */ public int StackMultiplier;
        [NMS(Index = 30)]
        /* 0x1C0 */ public GcTradeCategory TradeCategory;
        [NMS(Index = 14)]
        /* 0x1C4 */ public GcProductCategory Type;
        // size: 0x7
        ...
        [NMS(Index = 31)]
        /* 0x1C8 */ public WikiCategoryEnum WikiCategory;
        [NMS(Index = 1)]
        /* 0x1CC */ public NMSString0x80 Name;
        [NMS(Index = 2)]
        /* 0x24C */ public NMSString0x80 NameLower;
        [NMS(Index = 50)]
        /* 0x2CC */ public bool CanSendToOtherPlayers;
        [NMS(Index = 17)]
        /* 0x2CD */ public bool Consumable;
        [NMS(Index = 42)]
        /* 0x2CE */ public bool CookingIngredient;
        [NMS(Index = 48)]
        /* 0x2CF */ public bool EggModifierIngredient;
        [NMS(Index = 46)]
        /* 0x2D0 */ public bool GoodForSelling;
        [NMS(Index = 33)]
        /* 0x2D1 */ public bool IsCraftable;
        [NMS(Index = 49)]
        /* 0x2D2 */ public bool IsTechbox;
        [NMS(Index = 41)]
        /* 0x2D3 */ public bool NeverPinnable;
        [NMS(Index = 40)]
        /* 0x2D4 */ public bool PinObjectiveEasyToRefine;
        [NMS(Index = 27)]
        /* 0x2D5 */ public bool SpecificChargeOnly;
    }
}
