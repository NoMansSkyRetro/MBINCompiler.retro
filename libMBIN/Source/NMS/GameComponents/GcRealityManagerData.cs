...
namespace libMBIN.NMS.GameComponents
{
    ...
    public class GcRealityManagerData : NMSTemplate
    {
        ...
        [NMS(Index = 22)]
        /* 0x6B58 */ public List<VariableSizeString> AlienPuzzleTables;
        [NMS(Index = 21)]
        /* 0x6B68 */ public VariableSizeString AlienWordsTable;
        [NMS(Index = 20)]
        /* 0x6B78 */ public VariableSizeString BaitDataTable;
        [NMS(Index = 58)]
        /* 0x6B88 */ public List<GcRewardMissionOverride> BuilderMissionRewardOverrides;
        [NMS(Index = 45)]
        ...
        [NMS(Index = 26)]
        /* 0x6BC8 */ public List<GcDamageMultiplierLookup> DamageMultiplierTable;
        [NMS(Index = 32)]
        ...
        [NMS(Index = 86)]
        /* 0x6C08 */ public List<GcFiendCrimeSpawnTable> FiendCrimeSpawnTable;
        [NMS(Index = 19)]
        /* 0x6C18 */ public VariableSizeString FishDataTable;
        [NMS(Index = 87)]
        /* 0x6C28 */ public List<GcIDPair> FreighterBaseItemPairs;
        [NMS(Index = 47)]
        /* 0x6C38 */ public List<GcFreighterCargoOption> FreighterCargoOptions;
        [NMS(Index = 27)]
        ...
        [NMS(Index = 12)]
        /* 0x6C78 */ public List<TkRawID> LegacyRepairTable;
        [NMS(Index = 41)]
        /* 0x6C88 */ public VariableSizeString MaintenanceGroupsTable;
        [NMS(Index = 18)]
        /* 0x6C98 */ public VariableSizeString MaintenanceOverrideTable;
        [NMS(Index = 84)]
        /* 0x6CA8 */ public List<NMSString0x10> NeverOfferedForSale;
        [NMS(Index = 83)]
        /* 0x6CB8 */ public List<NMSString0x10> NeverSellableItems;
        [NMS(Index = 73)]
        /* 0x6CC8 */ public List<NMSString0x10> PirateStationExtraProds;
        [NMS(Index = 44)]
        ...
        [NMS(Index = 4)]
        /* 0x6D98 */ public List<GcSubstanceSecondaryLookup> SubstanceSecondaryLookups;
        [NMS(Index = 7)]
        /* 0x6DA8 */ public VariableSizeString SubstanceTable;
        [NMS(Index = 82)]
        /* 0x6DB8 */ public List<int> SuitCargoUpgradePrices;
        [NMS(Index = 81)]
        /* 0x6DC8 */ public List<int> SuitTechOnlyUpgradePrices;
        [NMS(Index = 80)]
        /* 0x6DD8 */ public List<int> SuitUpgradePrices;
        [NMS(Index = 46)]
