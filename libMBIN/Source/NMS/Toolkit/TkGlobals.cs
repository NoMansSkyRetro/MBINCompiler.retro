...
{
    [NMS(GUID = 0x2BD7530FD803EB69, NameHash = 0xD42BEC5C)]
    public class TkGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 18)]
        /* 0x4D2 */ public bool EnableVirtualTouchScreen;
        [NMS(Index = 6)]
        /* 0x4D3 */ public bool EnableZstdSaves;
        [NMS(Index = 15)]
        /* 0x4D4 */ public bool FavouritesAndUndoEnabledByDefault;
        [NMS(Index = 13)]
        /* 0x4D5 */ public bool FilterTranslatedTextWhenSearching;
        [NMS(Index = 30)]
        /* 0x4D6 */ public bool ForceGPUPreset;
        [NMS(Index = 38)]
        /* 0x4D7 */ public bool ForceSteamDeck;
        [NMS(Index = 39)]
        /* 0x4D8 */ public bool ForceWinGdkHandheld;
        [NMS(Index = 33)]
        /* 0x4D9 */ public bool FreezeCulling;
        [NMS(Index = 62)]
        /* 0x4DA */ public bool HideRenderdocOverlay;
        [NMS(Index = 85)]
        /* 0x4DB */ public bool HmdDistortionPassthru;
        [NMS(Index = 80)]
        /* 0x4DC */ public bool HmdEnable;
        [NMS(Index = 81)]
        /* 0x4DD */ public bool HmdFoveated;
        [NMS(Index = 84)]
        /* 0x4DE */ public bool HmdStereoRender;
        [NMS(Index = 83)]
        /* 0x4DF */ public bool HmdTracking;
        [NMS(Index = 36)]
        /* 0x4E0 */ public bool JitterRenderOffsetEveryFrame;
        [NMS(Index = 59)]
        /* 0x4E1 */ public bool LoadRelativeEditorLayouts;
        [NMS(Index = 17)]
        /* 0x4E2 */ public bool LogInputChanges;
        [NMS(Index = 16)]
        /* 0x4E3 */ public bool LogInputSetup;
        [NMS(Index = 32)]
        /* 0x4E4 */ public bool MakeUnusedUniformsNaN;
        [NMS(Index = 29)]
        /* 0x4E5 */ public bool MinGPUMode;
        [NMS(Index = 66)]
        /* 0x4E6 */ public bool OctahedralImpostersViewFromSpace;
        [NMS(Index = 56)]
        /* 0x4E7 */ public bool SampleCollisionWithCamera;
        [NMS(Index = 98)]
        /* 0x4E8 */ public bool ScratchpadInstanced;
        [NMS(Index = 99)]
        /* 0x4E9 */ public bool ScratchpadWind;
        [NMS(Index = 57)]
        /* 0x4EA */ public bool ShowPlayerCollisions;
        [NMS(Index = 43)]
        /* 0x4EB */ public bool SimulateDisabledParticleRefractions;
        [NMS(Index = 45)]
        /* 0x4EC */ public bool SmokeTestSmokeBotAutoStart;
        [NMS(Index = 48)]
        /* 0x4ED */ public bool UseDebugScreenSettings;
        [NMS(Index = 42)]
        /* 0x4EE */ public bool UseHeavyAir;
        [NMS(Index = 72)]
        /* 0x4EF */ public bool VulkanValidationEnabled;
        [NMS(Index = 73)]
        /* 0x4F0 */ public bool VulkanValidationPrintMessages;
        [NMS(Index = 74)]
        /* 0x4F1 */ public bool VulkanValidationPrintUniqueOnly;
    }
}
