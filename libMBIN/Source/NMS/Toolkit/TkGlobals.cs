...
{
    [NMS(GUID = 0x490118A754D68BAD, NameHash = 0xD42BEC5C)]
    public class TkGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 41)]
        /* 0x4BA */ public bool DisableVSync;
        [NMS(Index = 54)]
        /* 0x4BB */ public bool EnableInstancedModelImposters;
        [NMS(Index = 53)]
        /* 0x4BC */ public bool EnableNvidiaAftermath;
        [NMS(Index = 51)]
        /* 0x4BD */ public bool EnableRenderdoc;
        [NMS(Index = 18)]
        /* 0x4BE */ public bool EnableShaderReload;
        [NMS(Index = 14)]
        /* 0x4BF */ public bool EnableVirtualTouchScreen;
        [NMS(Index = 10)]
        /* 0x4C0 */ public bool FilterTranslatedTextWhenSearching;
        [NMS(Index = 25)]
        /* 0x4C1 */ public bool ForceGPUPreset;
        [NMS(Index = 28)]
        /* 0x4C2 */ public bool FreezeCulling;
        [NMS(Index = 52)]
        /* 0x4C3 */ public bool HideRenderdocOverlay;
        [NMS(Index = 70)]
        /* 0x4C4 */ public bool HmdDistortionPassthru;
        [NMS(Index = 65)]
        /* 0x4C5 */ public bool HmdEnable;
        [NMS(Index = 66)]
        /* 0x4C6 */ public bool HmdFoveated;
        [NMS(Index = 69)]
        /* 0x4C7 */ public bool HmdStereoRender;
        [NMS(Index = 68)]
        /* 0x4C8 */ public bool HmdTracking;
        [NMS(Index = 50)]
        /* 0x4C9 */ public bool LoadRelativeEditorLayouts;
        [NMS(Index = 13)]
        /* 0x4CA */ public bool LogInputChanges;
        [NMS(Index = 12)]
        /* 0x4CB */ public bool LogInputSetup;
        [NMS(Index = 27)]
        /* 0x4CC */ public bool MakeUnusedUniformsNaN;
        [NMS(Index = 24)]
        /* 0x4CD */ public bool MinGPUMode;
        [NMS(Index = 56)]
        /* 0x4CE */ public bool OctahedralImpostersDisable;
        [NMS(Index = 55)]
        /* 0x4CF */ public bool OctahedralImpostersEnable;
        [NMS(Index = 57)]
        /* 0x4D0 */ public bool OctahedralImpostersViewFromSpace;
        [NMS(Index = 46)]
        /* 0x4D1 */ public bool SampleCollisionWithCamera;
        [NMS(Index = 83)]
        /* 0x4D2 */ public bool ScratchpadInstanced;
        [NMS(Index = 84)]
        /* 0x4D3 */ public bool ScratchpadWind;
        [NMS(Index = 47)]
        /* 0x4D4 */ public bool ShowPlayerCollisions;
        [NMS(Index = 33)]
        /* 0x4D5 */ public bool SimulateDisabledParticleRefractions;
        [NMS(Index = 35)]
        /* 0x4D6 */ public bool SmokeTestSmokeBotAutoStart;
        [NMS(Index = 48)]
        /* 0x4D7 */ public bool SupportWaterHeightQueries;
        [NMS(Index = 38)]
        /* 0x4D8 */ public bool UseDebugScreenSettings;
        [NMS(Index = 32)]
        /* 0x4D9 */ public bool UseHeavyAir;
    }
}
