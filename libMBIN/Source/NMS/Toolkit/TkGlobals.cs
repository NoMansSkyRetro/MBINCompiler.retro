...
{
    [NMS(GUID = 0x8B7D17EC63C9652F, NameHash = 0xD42BEC5C)]
    public class TkGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 5)]
        /* 0x4C2 */ public bool EnableZstdSaves;
        [NMS(Index = 13)]
        /* 0x4C3 */ public bool FavouritesAndUndoEnabledByDefault;
        [NMS(Index = 11)]
        /* 0x4C4 */ public bool FilterTranslatedTextWhenSearching;
        [NMS(Index = 27)]
        /* 0x4C5 */ public bool ForceGPUPreset;
        [NMS(Index = 30)]
        /* 0x4C6 */ public bool FreezeCulling;
        [NMS(Index = 53)]
        /* 0x4C7 */ public bool HideRenderdocOverlay;
        [NMS(Index = 73)]
        /* 0x4C8 */ public bool HmdDistortionPassthru;
        [NMS(Index = 68)]
        /* 0x4C9 */ public bool HmdEnable;
        [NMS(Index = 69)]
        /* 0x4CA */ public bool HmdFoveated;
        [NMS(Index = 72)]
        /* 0x4CB */ public bool HmdStereoRender;
        [NMS(Index = 71)]
        /* 0x4CC */ public bool HmdTracking;
        [NMS(Index = 51)]
        /* 0x4CD */ public bool LoadRelativeEditorLayouts;
        [NMS(Index = 15)]
        /* 0x4CE */ public bool LogInputChanges;
        [NMS(Index = 14)]
        /* 0x4CF */ public bool LogInputSetup;
        [NMS(Index = 29)]
        /* 0x4D0 */ public bool MakeUnusedUniformsNaN;
        [NMS(Index = 26)]
        /* 0x4D1 */ public bool MinGPUMode;
        [NMS(Index = 58)]
        /* 0x4D2 */ public bool OctahedralImpostersDisable;
        [NMS(Index = 57)]
        /* 0x4D3 */ public bool OctahedralImpostersEnable;
        [NMS(Index = 59)]
        /* 0x4D4 */ public bool OctahedralImpostersViewFromSpace;
        [NMS(Index = 48)]
        /* 0x4D5 */ public bool SampleCollisionWithCamera;
        [NMS(Index = 86)]
        /* 0x4D6 */ public bool ScratchpadInstanced;
        [NMS(Index = 87)]
        /* 0x4D7 */ public bool ScratchpadWind;
        [NMS(Index = 49)]
        /* 0x4D8 */ public bool ShowPlayerCollisions;
        [NMS(Index = 35)]
        /* 0x4D9 */ public bool SimulateDisabledParticleRefractions;
        [NMS(Index = 37)]
        /* 0x4DA */ public bool SmokeTestSmokeBotAutoStart;
        [NMS(Index = 40)]
        /* 0x4DB */ public bool UseDebugScreenSettings;
        [NMS(Index = 34)]
        /* 0x4DC */ public bool UseHeavyAir;
    }
}
