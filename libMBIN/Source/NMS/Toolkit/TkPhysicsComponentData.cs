...
{
    [NMS(GUID = 0x9A3D5A238D3FE7CC, NameHash = 0xF90BB3)]
    public class TkPhysicsComponentData : NMSTemplate
    {
        ...
        [NMS(Index = 12)]
        /* 0x54 */ public bool NoTerrainCollide;
        [NMS(Index = 10)]
        /* 0x55 */ public bool NoVehicleCollide;
        [NMS(Index = 29)]
        /* 0x56 */ public bool RotateSimpleCharacterCollisionCapsule;
        [NMS(Index = 23)]
        /* 0x57 */ public bool ScaleAffectsMass;
        [NMS(Index = 2)]
        /* 0x58 */ public bool TriggerVolume;
        [NMS(Index = 26)]
        /* 0x59 */ public bool UseBasePartOptimisation;
        [NMS(Index = 28)]
        /* 0x5A */ public bool UseSimpleCharacterCollision;
        [NMS(Index = 7)]
        /* 0x5B */ public bool Walkable;
    }
}
