...
{
    [NMS(GUID = 0x2FAA0B4F5E44EB27, NameHash = 0xF90BB3)]
    public class TkPhysicsComponentData : NMSTemplate
    {
        ...
        [NMS(Index = 5)]
        /* 0x3E */ public bool Climbable;
        [NMS(Index = 20)]
        /* 0x3F */ public bool DisableGravity;
        [NMS(Index = 7)]
        /* 0x40 */ public bool Floor;
        [NMS(Index = 14)]
        /* 0x41 */ public bool IgnoreAllCollisions;
        [NMS(Index = 8)]
        /* 0x42 */ public bool IgnoreModelOwner;
        [NMS(Index = 17)]
        /* 0x43 */ public bool InvisibleForInteraction;
        [NMS(Index = 26)]
        /* 0x44 */ public bool IsTransporter;
        [NMS(Index = 13)]
        /* 0x45 */ public bool NoFallDamage;
        [NMS(Index = 12)]
        /* 0x46 */ public bool NoFireCollide;
        [NMS(Index = 10)]
        /* 0x47 */ public bool NoPlayerCollide;
        [NMS(Index = 11)]
        /* 0x48 */ public bool NoTerrainCollide;
        [NMS(Index = 9)]
        /* 0x49 */ public bool NoVehicleCollide;
        [NMS(Index = 28)]
        /* 0x4A */ public bool RotateSimpleCharacterCollisionCapsule;
        [NMS(Index = 22)]
        /* 0x4B */ public bool ScaleAffectsMass;
        [NMS(Index = 1)]
        /* 0x4C */ public bool TriggerVolume;
        [NMS(Index = 25)]
        /* 0x4D */ public bool UseBasePartOptimisation;
        [NMS(Index = 27)]
        /* 0x4E */ public bool UseSimpleCharacterCollision;
        [NMS(Index = 6)]
        /* 0x4F */ public bool Walkable;
    }
}
