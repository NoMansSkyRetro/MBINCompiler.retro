...
{
    [NMS(GUID = 0x42D2AADB68B0BA37, NameHash = 0x8122CE73)]
    public class GcGameTableGlobals : NMSTemplate
    {
        [NMS(Index = 129, Size = 0x9, EnumType = typeof(GcPetBattlerAffinity.PetBattlerAffinityEnum))]
        /* 0x0000 */ public Colour[] PetAffinityGlowColours;
        [NMS(Index = 136, Size = 0x7, EnumType = typeof(GcPetBattlerVRPanel.PetBattlerVRPanelEnum))]
        ...
        [NMS(Index = 112, Size = 0xA, EnumType = typeof(GcPetBattlerMoveEffect.PetBattlerMoveEffectEnum))]
        /* 0x01A0 */ public GcPetBattlerEffectTable[] EffectTables;
        [NMS(Index = 109, Size = 0x9, EnumType = typeof(GcPetBattlerAffinity.PetBattlerAffinityEnum))]
        ...
        [NMS(Index = 125, Size = 0xA, EnumType = typeof(GcPetBattlerMoveEffect.PetBattlerMoveEffectEnum))]
        ...
        [NMS(Index = 102, Size = 0x3, EnumType = typeof(GcCreaturePetTraits.PetTraitEnum))]
        ...
        [NMS(Index = 98, Size = 0xF, EnumType = typeof(GcPetBattlerStat.PetBattlerStatEnum))]
        /* 0x1DE8 */ public float[] PetStatPayloadBoosts;
        [NMS(Index = 85, Size = 0x3, EnumType = typeof(GcPetBattlerCoreStat.PetBattlerCoreStatEnum))]
        /* 0x1E24 */ public GcPetBattlerCoreStatRollData[] CoreStatClassPerLevelBoosts;
        [NMS(Index = 79, Size = 0x3, EnumType = typeof(GcPetBattlerCoreStat.PetBattlerCoreStatEnum))]
        /* 0x1E54 */ public GcPetBattlerCoreStatRollData[] CoreStatClassRollTable;
        [NMS(Index = 134, Size = 0x7, EnumType = typeof(GcPetBattlerVRPanel.PetBattlerVRPanelEnum))]
        ...
        [NMS(Index = 104, Size = 0x5, EnumType = typeof(GcPetBattlerPayloadStrength.PetPayloadStrengthEnum))]
        ...
        [NMS(Index = 122, Size = 0x3, EnumType = typeof(GcPetBattlerAffinityEffectiveness.PetBattlerAffinityEffectivenessEnum))]
        /* 0x1F0C */ public float[] AffinityDamageEffectiveness;
        [NMS(Index = 59, Size = 0x3, EnumType = typeof(GcPetBattlerCoreStat.PetBattlerCoreStatEnum))]
        ...
        [NMS(Index = 45)]
        /* 0x2094 */ public float XPAwardMulMax;
        [NMS(Index = 44)]
        /* 0x2098 */ public float XPAwardMulMin;
        [NMS(Index = 46)]
        /* 0x209C */ public float XPValueBaseMul;
        [NMS(Index = 119, Size = 0x9, EnumType = typeof(GcPetBattlerAffinity.PetBattlerAffinityEnum))]
        /* 0x20A0 */ public NMSString0x20[] PetAffinityInTextIconName;
        [NMS(Index = 117, Size = 0x9, EnumType = typeof(GcPetBattlerAffinity.PetBattlerAffinityEnum))]
        /* 0x21C0 */ public NMSString0x20[] PetAffinityLocStub;
        [NMS(Index = 118, Size = 0x9, EnumType = typeof(GcPetBattlerTarget.PetBattlerTargetEnum))]
        /* 0x22E0 */ public NMSString0x20[] PetTargetLoc;
        [NMS(Index = 113, Size = 0x11, EnumType = typeof(GcBiomeType.BiomeEnum))]
        /* 0x2400 */ public GcPetBattlerAffinity[] PetBiomeAffinities;
        [NMS(Index = 86, Size = 0xF, EnumType = typeof(GcPetBattlerStat.PetBattlerStatEnum))]
        /* 0x2411 */ public bool[] IsOffensiveStat;
        [NMS(Index = 120, Size = 0x9, EnumType = typeof(GcPetBattlerAffinity.PetBattlerAffinityEnum))]
        /* 0x2420 */ public GcPetBattlerAffinity[] PetAffinityStrongVersus;
        [NMS(Index = 121, Size = 0x9, EnumType = typeof(GcPetBattlerAffinity.PetBattlerAffinityEnum))]
        /* 0x2429 */ public GcPetBattlerAffinity[] PetAffinityWeakVersus;
        [NMS(Index = 3)]
        /* 0x2432 */ public bool ShowDebugStatus;
    }
}
