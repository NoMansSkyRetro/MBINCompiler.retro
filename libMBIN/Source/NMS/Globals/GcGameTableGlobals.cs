...
{
    [NMS(GUID = 0xBB16518B56D69952, NameHash = 0x8122CE73)]
    public class GcGameTableGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 42, Size = 0x4, EnumType = typeof(GcInventoryClass.InventoryClassEnum))]
        ...
        [NMS(Index = 49)]
        /* 0x202C */ public float PetBaseCritChance;
        [NMS(Index = 50)]
        /* 0x2030 */ public float PetBaseCritDamageMul;
        [NMS(Index = 52)]
        /* 0x2034 */ public float PetBaseDodgeChance;
        [NMS(Index = 51)]
        /* 0x2038 */ public float PetBaseMissChance;
        [NMS(Index = 132)]
        /* 0x203C */ public int PetBattlerImpactScreenHeight;
        [NMS(Index = 130)]
        /* 0x2040 */ public float PetBattlerImpactScreenScale;
        [NMS(Index = 131)]
        /* 0x2044 */ public int PetBattlerImpactScreenWidth;
        [NMS(Index = 104)]
        /* 0x2048 */ public float PetDamageShakeAmplitude;
        [NMS(Index = 105)]
        /* 0x204C */ public float PetDamageShakeDampingStrength;
        [NMS(Index = 106)]
        /* 0x2050 */ public float PetDamageShakePhaseHz;
        [NMS(Index = 107)]
        /* 0x2054 */ public float PetEffectCooldownTime;
        [NMS(Index = 127)]
        /* 0x2058 */ public float PetHealthBarAnimSpeed;
        [NMS(Index = 32)]
        /* 0x205C */ public float PetKOSwapDelayTime;
        [NMS(Index = 81)]
        /* 0x2060 */ public int PetMaxLevel;
        [NMS(Index = 53)]
        /* 0x2064 */ public float PetMissAgiltyBasedExtra;
        [NMS(Index = 31)]
        /* 0x2068 */ public float PostMovePauseTime;
        [NMS(Index = 80)]
        /* 0x206C */ public float TeamStrengthMaxLevelsBelowHighestLevelMember;
        [NMS(Index = 79)]
        /* 0x2070 */ public float TeamStrengthShiftTowardsHighestLevelMemberFactor;
        [NMS(Index = 5)]
        /* 0x2074 */ public float TriggerTeleportEffectForRemotePlayersOnTableInteractDistance;
        [NMS(Index = 15)]
        /* 0x2078 */ public int TurnTimerFailureDecrement;
        [NMS(Index = 17)]
        /* 0x207C */ public int TurnTimerMaxValue;
        [NMS(Index = 16)]
        /* 0x2080 */ public int TurnTimerMinValue;
        [NMS(Index = 18)]
        /* 0x2084 */ public int TurnTimerShowThreshold;
        [NMS(Index = 13)]
        /* 0x2088 */ public int TurnTimerStartingValue;
        [NMS(Index = 14)]
        /* 0x208C */ public int TurnTimerSuccessIncrement;
        [NMS(Index = 44)]
        /* 0x2090 */ public float XPAwardMulMax;
        [NMS(Index = 43)]
        /* 0x2094 */ public float XPAwardMulMin;
        [NMS(Index = 45)]
