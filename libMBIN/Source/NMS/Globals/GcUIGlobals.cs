...
{
    [NMS(GUID = 0x28CD209B5ADF9A11, NameHash = 0xD1FA1B1C)]
    public class GcUIGlobals : NMSTemplate
    {
        [NMS(Index = 1090)]
        /* 0x0000 */ public GcModelViewCollection ModelViews;
        [NMS(Index = 1089, Size = 0xB, EnumType = typeof(GcSpaceshipClasses.ShipClassEnum))]
        ...
        [NMS(Index = 871, Size = 0x5, EnumType = typeof(GcGalaxyStarTypes.GalaxyStarTypeEnum))]
        ...
        [NMS(Index = 64, Size = 0xF, EnumType = typeof(GcWonderCreatureCategory.WonderCreatureCategoryEnum))]
        /* 0x4370 */ public GcWonderCategoryConfig[] WonderCreatureCategoryConfig;
        [NMS(Index = 67, Size = 0xD, EnumType = typeof(GcWonderTreasureCategory.WonderTreasureCategoryEnum))]
        ...
        [NMS(Index = 69, Size = 0xC, EnumType = typeof(GcWonderCustomCategory.WonderCustomCategoryEnum))]
        /* 0x5170 */ public GcWonderCategoryConfig[] WonderCustomCategoryConfig;
        [NMS(Index = 63, Size = 0xB, EnumType = typeof(GcWonderPlanetCategory.WonderPlanetCategoryEnum))]
        /* 0x5410 */ public GcWonderCategoryConfig[] WonderPlanetCategoryConfig;
        [NMS(Index = 68, Size = 0xB, EnumType = typeof(GcWonderWeirdBasePartCategory.WonderWeirdBasePartCategoryEnum))]
        /* 0x5678 */ public GcWonderCategoryConfig[] WonderWeirdBasePartCategoryConfig;
        [NMS(Index = 65, Size = 0x8, EnumType = typeof(GcWonderFloraCategory.WonderFloraCategoryEnum))]
        /* 0x58E0 */ public GcWonderCategoryConfig[] WonderFloraCategoryConfig;
        [NMS(Index = 66, Size = 0x8, EnumType = typeof(GcWonderMineralCategory.WonderMineralCategoryEnum))]
        ...
        [NMS(Index = 58, Size = 0x7, EnumType = typeof(GcWonderType.WonderTypeEnum))]
        ...
        [NMS(Index = 710, Size = 0x14, EnumType = typeof(GcPlayerWeapons.WeaponModeEnum))]
        ...
        [NMS(Index = 311)]
        /* 0x780C */ public float ShopInteractionInWorldForcedOffset;
        [NMS(Index = 312)]
        /* 0x7810 */ public float ShopInteractionInWorldForcedOffsetV2;
        [NMS(Index = 117)]
        /* 0x7814 */ public int ShowDaysIfLessThan;
        [NMS(Index = 116)]
        /* 0x7818 */ public int ShowHoursIfLessThan;
        [NMS(Index = 118)]
        /* 0x781C */ public int ShowWeeksIfLessThan;
        [NMS(Index = 727)]
        /* 0x7820 */ public float SmallSpaceIconSize;
        [NMS(Index = 249)]
        /* 0x7824 */ public float SolidPointerLengthScale;
        [NMS(Index = 250)]
        /* 0x7828 */ public float SolidPointerMaxLength;
        [NMS(Index = 248)]
        /* 0x782C */ public float SolidPointerScale;
        [NMS(Index = 1248)]
        /* 0x7830 */ public float SpaceMapActionScale;
        [NMS(Index = 1244)]
        /* 0x7834 */ public float SpaceMapAnomalyScale;
        [NMS(Index = 1234)]
        /* 0x7838 */ public float SpaceMapAspectRatio;
        [NMS(Index = 1260)]
        /* 0x783C */ public float SpaceMapCamAngle;
        [NMS(Index = 1261)]
        /* 0x7840 */ public float SpaceMapCamDistance;
        [NMS(Index = 1259)]
        /* 0x7844 */ public float SpaceMapCamHeight;
        [NMS(Index = 550)]
        /* 0x7848 */ public float SpaceMapCockpitAngle;
        [NMS(Index = 540)]
        /* 0x784C */ public float SpaceMapCockpitScale;
        [NMS(Index = 547)]
        /* 0x7850 */ public float SpaceMapCockpitScaleAdjustAlien;
        [NMS(Index = 549)]
        /* 0x7854 */ public float SpaceMapCockpitScaleAdjustCorvette;
        [NMS(Index = 541)]
        /* 0x7858 */ public float SpaceMapCockpitScaleAdjustDropShip;
        [NMS(Index = 542)]
        /* 0x785C */ public float SpaceMapCockpitScaleAdjustFighter;
        [NMS(Index = 548)]
        /* 0x7860 */ public float SpaceMapCockpitScaleAdjustRobot;
        [NMS(Index = 545)]
        /* 0x7864 */ public float SpaceMapCockpitScaleAdjustRoyal;
        [NMS(Index = 546)]
        /* 0x7868 */ public float SpaceMapCockpitScaleAdjustSail;
        [NMS(Index = 543)]
        /* 0x786C */ public float SpaceMapCockpitScaleAdjustScientific;
        [NMS(Index = 544)]
        /* 0x7870 */ public float SpaceMapCockpitScaleAdjustShuttle;
        [NMS(Index = 1253)]
        /* 0x7874 */ public float SpaceMapDistance;
        [NMS(Index = 1236)]
        /* 0x7878 */ public float SpaceMapDistanceLogScaler;
        [NMS(Index = 1255)]
        /* 0x787C */ public float SpaceMapDistanceMultiplier;
        [NMS(Index = 1235)]
        /* 0x7880 */ public float SpaceMapDistanceScale;
        [NMS(Index = 1258)]
        /* 0x7884 */ public float SpaceMapFadeAngleMax;
        [NMS(Index = 1257)]
        /* 0x7888 */ public float SpaceMapFadeAngleMin;
        [NMS(Index = 1233)]
        /* 0x788C */ public float SpaceMapFoV;
        [NMS(Index = 1242)]
        /* 0x7890 */ public float SpaceMapFreighterScale;
        [NMS(Index = 1256)]
        /* 0x7894 */ public float SpaceMapHorizonThickness;
        [NMS(Index = 1263)]
        /* 0x7898 */ public float SpaceMapLightPitch;
        [NMS(Index = 1264)]
        /* 0x789C */ public float SpaceMapLightYaw;
        [NMS(Index = 1217)]
        /* 0x78A0 */ public float SpaceMapLineBaseFade;
        [NMS(Index = 1216)]
        /* 0x78A4 */ public float SpaceMapLineBaseScale;
        [NMS(Index = 1215)]
        /* 0x78A8 */ public float SpaceMapLineWidth;
        [NMS(Index = 1252)]
        /* 0x78AC */ public float SpaceMapMarkerScale;
        [NMS(Index = 1254)]
        /* 0x78B0 */ public float SpaceMapMaxTraderDistance;
        [NMS(Index = 1247)]
        /* 0x78B4 */ public float SpaceMapMoonScale;
        [NMS(Index = 1241)]
        /* 0x78B8 */ public float SpaceMapObjectScale;
        [NMS(Index = 1251)]
        /* 0x78BC */ public float SpaceMapPirateFreighterScale;
        [NMS(Index = 1250)]
        /* 0x78C0 */ public float SpaceMapPirateFrigateScale;
        [NMS(Index = 1246)]
        /* 0x78C4 */ public float SpaceMapPlanetLineOffset;
        [NMS(Index = 1245)]
        /* 0x78C8 */ public float SpaceMapPlanetScale;
        [NMS(Index = 1238)]
        /* 0x78CC */ public float SpaceMapScaleMin;
        [NMS(Index = 1240)]
        /* 0x78D0 */ public float SpaceMapScaleRangeMax;
        [NMS(Index = 1239)]
        /* 0x78D4 */ public float SpaceMapScaleRangeMin;
        [NMS(Index = 1218)]
        /* 0x78D8 */ public float SpaceMapShipCombineDistance;
        [NMS(Index = 1249)]
        /* 0x78DC */ public float SpaceMapShipScale;
        [NMS(Index = 1262)]
        /* 0x78E0 */ public float SpaceMapShipScaleMin;
        [NMS(Index = 1243)]
        /* 0x78E4 */ public float SpaceMapStationScale;
        [NMS(Index = 725)]
        /* 0x78E8 */ public float SpaceMarkersBattleOffset;
        [NMS(Index = 724)]
        /* 0x78EC */ public float SpaceMarkersOffset;
        [NMS(Index = 124)]
        /* 0x78F0 */ public float StackSizeChangeMaxRate;
        [NMS(Index = 123)]
        /* 0x78F4 */ public float StackSizeChangeMinRate;
        [NMS(Index = 122)]
        /* 0x78F8 */ public float StackSizeRateChangeRate;
        [NMS(Index = 114)]
        /* 0x78FC */ public float StageStingDisplayTime;
        [NMS(Index = 521)]
        /* 0x7900 */ public float StandingRewardOSDTime;
        [NMS(Index = 884)]
        /* 0x7904 */ public float StatsMessageDelayTime;
        [NMS(Index = 27)]
        /* 0x7908 */ public float StoreDialDecayTime;
        [NMS(Index = 26)]
        /* 0x790C */ public float StoreDialHoldTime;
        [NMS(Index = 28)]
        /* 0x7910 */ public float StoreDialInnerRadius;
        [NMS(Index = 29)]
        /* 0x7914 */ public float StoreDialOuterRadius;
        [NMS(Index = 82)]
        /* 0x7918 */ public float SuperchargeGradientFactor;
        [NMS(Index = 81)]
        /* 0x791C */ public float SuperchargeGradientFactorMin;
        [NMS(Index = 83)]
        /* 0x7920 */ public float SuperchargeGradientTime;
        [NMS(Index = 792)]
        /* 0x7924 */ public float SurveyObjectArrowOffsetMultiplier;
        [NMS(Index = 352)]
        /* 0x7928 */ public float TakeoffFuelMessageTime;
        [NMS(Index = 581)]
        /* 0x792C */ public float TalkBoxAlienTextSpeed;
        [NMS(Index = 583)]
        /* 0x7930 */ public float TalkBoxAlienTextTimeMax;
        [NMS(Index = 582)]
        /* 0x7934 */ public float TalkBoxAlienTextTimeMin;
        [NMS(Index = 556)]
        /* 0x7938 */ public float TargetDisplayDamageFlashTime;
        [NMS(Index = 551)]
        /* 0x793C */ public float TargetDisplayScale;
        [NMS(Index = 553)]
        /* 0x7940 */ public float TargetDisplayShipScale;
        [NMS(Index = 552)]
        /* 0x7944 */ public float TargetDisplayTorpedoScale;
        [NMS(Index = 1206)]
        /* 0x7948 */ public float TargetMarkerFadeAngleMin;
        [NMS(Index = 1207)]
        /* 0x794C */ public float TargetMarkerFadeAngleRange;
        [NMS(Index = 1205)]
        /* 0x7950 */ public float TargetMarkerScaleEnd;
        [NMS(Index = 1204)]
        /* 0x7954 */ public float TargetMarkerScaleStart;
        [NMS(Index = 1389)]
        /* 0x7958 */ public float TargetParallaxMaintenancePageMultiplier;
        [NMS(Index = 1388)]
        /* 0x795C */ public float TargetParallaxMouseMultiplier;
        [NMS(Index = 1010)]
        /* 0x7960 */ public float TargetScreenDistance;
        [NMS(Index = 1009)]
        /* 0x7964 */ public float TargetScreenFoV;
        [NMS(Index = 807)]
        /* 0x7968 */ public float TechDisplayDelayTime;
        [NMS(Index = 451)]
        /* 0x796C */ public float TechPopupBuildLayerHeight;
        [NMS(Index = 449)]
        /* 0x7970 */ public float TechPopupInstallLayerHeight;
        [NMS(Index = 450)]
        /* 0x7974 */ public float TechPopupRepairLayerHeight;
        [NMS(Index = 452)]
        /* 0x7978 */ public float TechPopupRequirementHeight;
        [NMS(Index = 1412)]
        /* 0x797C */ public float TextChatMaxDisplayTime;
        [NMS(Index = 1413)]
        /* 0x7980 */ public float TextChatStayBigAfterTextInput;
        [NMS(Index = 188)]
        /* 0x7984 */ public float TextPrintoutMultiplier;
        [NMS(Index = 189)]
        /* 0x7988 */ public float TextPrintoutMultiplierAlien;
        [NMS(Index = 22)]
        /* 0x798C */ public float TextTouchScrollCap;
        [NMS(Index = 770)]
        /* 0x7990 */ public float ThirdPersonCrosshairCircle1Distance;
        [NMS(Index = 771)]
        /* 0x7994 */ public float ThirdPersonCrosshairCircle2Distance;
        [NMS(Index = 769)]
        /* 0x7998 */ public float ThirdPersonCrosshairDistance;
        [NMS(Index = 596)]
        /* 0x799C */ public float TimedEventLookTime;
        [NMS(Index = 934)]
        /* 0x79A0 */ public float TooltipTime;
        [NMS(Index = 23)]
        /* 0x79A4 */ public float TouchScrollChangePageThreshold;
        [NMS(Index = 20)]
        /* 0x79A8 */ public float TouchScrollMaxDelta;
        [NMS(Index = 21)]
        /* 0x79AC */ public float TouchScrollSpeedMul;
        [NMS(Index = 767)]
        /* 0x79B0 */ public float TrackCriticalHitSize;
        [NMS(Index = 768)]
        /* 0x79B4 */ public float TrackCriticalPulseTime;
        [NMS(Index = 743)]
        /* 0x79B8 */ public float TrackLeadTargetInScale;
        [NMS(Index = 740)]
        /* 0x79BC */ public float TrackMissileTargetPulseRate;
        [NMS(Index = 733)]
        /* 0x79C0 */ public float TrackPoliceFreighterCentreOffset;
        [NMS(Index = 732)]
        /* 0x79C4 */ public float TrackPrimaryCentreOffset;
        [NMS(Index = 745)]
        /* 0x79C8 */ public float TrackReticuleAngle;
        [NMS(Index = 747)]
        /* 0x79CC */ public float TrackReticuleInactiveTime;
        [NMS(Index = 746)]
        /* 0x79D0 */ public float TrackReticuleInTime;
        [NMS(Index = 749)]
        /* 0x79D4 */ public float TrackReticuleRandomDelay;
        [NMS(Index = 748)]
        /* 0x79D8 */ public float TrackReticuleRandomTime;
        [NMS(Index = 744)]
        /* 0x79DC */ public float TrackReticuleScale;
        [NMS(Index = 741)]
        /* 0x79E0 */ public float TrackScaleCritical;
        [NMS(Index = 742)]
        /* 0x79E4 */ public float TrackScaleHit;
        [NMS(Index = 734)]
        /* 0x79E8 */ public float TrackTimerAlpha;
        [NMS(Index = 738)]
        /* 0x79EC */ public float TrackTimerIconExclaimRadius;
        [NMS(Index = 737)]
        /* 0x79F0 */ public float TrackTimerIconInnerRadius;
        [NMS(Index = 736)]
        /* 0x79F4 */ public float TrackTimerIconOuterRadius;
        [NMS(Index = 735)]
        /* 0x79F8 */ public float TrackTimerRadarPulseSize;
        [NMS(Index = 731)]
        /* 0x79FC */ public float TrackTypeIconSize;
        [NMS(Index = 25)]
        /* 0x7A00 */ public float TradePageNotifyOffset;
        [NMS(Index = 363)]
        /* 0x7A04 */ public float TransferPopupCursorOffsetFactor;
        [NMS(Index = 595)]
        /* 0x7A08 */ public float TransferSendOffscreenBorder;
        [NMS(Index = 502)]
        /* 0x7A0C */ public float TransitionOffset;
        [NMS(Index = 314)]
        /* 0x7A10 */ public float TravelLineThickness;
        [NMS(Index = 313)]
        /* 0x7A14 */ public float TravelTargetRadius;
        [NMS(Index = 32)]
        /* 0x7A18 */ public float TrialUpsellDeclineDecayTimeQuick;
        [NMS(Index = 34)]
        /* 0x7A1C */ public float TrialUpsellDeclineDecayTimeSlow;
        [NMS(Index = 35)]
        /* 0x7A20 */ public float TrialUpsellDeclineDialInnerRadius;
        [NMS(Index = 36)]
        /* 0x7A24 */ public float TrialUpsellDeclineDialOuterRadius;
        [NMS(Index = 31)]
        /* 0x7A28 */ public float TrialUpsellDeclineHoldTimeQuick;
        [NMS(Index = 33)]
        /* 0x7A2C */ public float TrialUpsellDeclineHoldTimeSlow;
        [NMS(Index = 97)]
        /* 0x7A30 */ public int UnknownWordsToShowInCatalogue;
        [NMS(Index = 100)]
        /* 0x7A34 */ public float UseZoomedOutBuildCamRadius;
        [NMS(Index = 209)]
        /* 0x7A38 */ public int VRFaceLockedScreenHeight;
        [NMS(Index = 208)]
        /* 0x7A3C */ public int VRFaceLockedScreenWidth;
        [NMS(Index = 350)]
        /* 0x7A40 */ public float WantedDetectMessageTime;
        [NMS(Index = 351)]
        /* 0x7A44 */ public float WantedDetectMinTimeout;
        [NMS(Index = 880)]
        /* 0x7A48 */ public float WantedLevelScanAlpha;
        [NMS(Index = 881)]
        /* 0x7A4C */ public float WantedLevelScannedRate;
        [NMS(Index = 878)]
        /* 0x7A50 */ public float WantedLevelTimeoutPulseRate;
        [NMS(Index = 879)]
        /* 0x7A54 */ public float WantedLevelWitnessAlpha;
        [NMS(Index = 877)]
        /* 0x7A58 */ public float WantedLevelWitnessOffset;
        [NMS(Index = 876)]
        /* 0x7A5C */ public float WantedLevelWitnessPulseRate;
        [NMS(Index = 127)]
        /* 0x7A60 */ public float ZoomFactorOverride;
        [NMS(Index = 946)]
        /* 0x7A64 */ public float ZoomHUDElementsOffsetX;
        [NMS(Index = 947)]
        /* 0x7A68 */ public float ZoomHUDElementsOffsetY;
        [NMS(Index = 948)]
        /* 0x7A6C */ public float ZoomHUDElementTime;
        [NMS(Index = 1308)]
        /* 0x7A70 */ public NMSString0x100 HUDCircleAnimIcon;
        [NMS(Index = 1306)]
        /* 0x7B70 */ public NMSString0x100 HUDDeathPointIcon;
        [NMS(Index = 1307)]
        /* 0x7C70 */ public NMSString0x100 HUDHexAnimIcon;
        [NMS(Index = 1302)]
        /* 0x7D70 */ public NMSString0x100 HUDMarkerColourIcon;
        [NMS(Index = 1300)]
        /* 0x7E70 */ public NMSString0x100 HUDMarkerIcon;
        [NMS(Index = 1301)]
        /* 0x7F70 */ public NMSString0x100 HUDMarkerPrimaryIndicatorIcon;
        [NMS(Index = 1303)]
        /* 0x8070 */ public NMSString0x100 HUDPointIcon;
        [NMS(Index = 1305)]
        /* 0x8170 */ public NMSString0x100 HUDSaveIcon;
        [NMS(Index = 1304)]
        /* 0x8270 */ public NMSString0x100 HUDSpaceshipIcon;
        [NMS(Index = 944)]
        /* 0x8370 */ public NMSString0x20 DistanceUnitKM;
        [NMS(Index = 943)]
        /* 0x8390 */ public NMSString0x20 DistanceUnitM;
        [NMS(Index = 945)]
        /* 0x83B0 */ public NMSString0x20 DistanceUnitMpS;
        [NMS(Index = 511)]
        /* 0x83D0 */ public NMSString0x20 MaxDialogCharSizeIdeographicString;
        [NMS(Index = 509)]
        /* 0x83F0 */ public NMSString0x20 MaxDialogCharSizeRomanString;
        [NMS(Index = 205)]
        /* 0x8410 */ public NMSString0x20 VRDistanceWarningUIFile;
        [NMS(Index = 397, Size = 0x15, EnumType = typeof(GcBuildMenuOption.BuildMenuOptionEnum))]
        /* 0x8430 */ public bool[] BuildMenuUseSmallIconOnPad;
        [NMS(Index = 1447)]
        /* 0x8445 */ public bool AllowInventorySorting;
        [NMS(Index = 191)]
        /* 0x8446 */ public bool AllowInWorldDebugBorders;
        [NMS(Index = 182)]
        /* 0x8447 */ public bool AllowProjectorRepositioning;
        [NMS(Index = 321)]
        /* 0x8448 */ public bool AlwaysCloseQuickMenu;
        [NMS(Index = 673)]
        /* 0x8449 */ public TkCurveType ArrowBounceLeftCurve;
        [NMS(Index = 669)]
        /* 0x844A */ public TkCurveType ArrowBounceRightCurve;
        [NMS(Index = 102)]
        /* 0x844B */ public bool AutoScrollParagraphs;
        [NMS(Index = 425)]
        /* 0x844C */ public bool BaseBuildingSmoothMenuWhileSnapped;
        [NMS(Index = 90)]
        /* 0x844D */ public bool BigPicking;
        [NMS(Index = 91)]
        /* 0x844E */ public bool BigPickingUsesNumbers;
        [NMS(Index = 166)]
        /* 0x844F */ public bool BinocularScanScreen;
        [NMS(Index = 386)]
        /* 0x8450 */ public TkCurveType CompassCurve;
        [NMS(Index = 755)]
        /* 0x8451 */ public bool CreatureInteractLabelUseBB;
        [NMS(Index = 754)]
        /* 0x8452 */ public TkCurveType CreatureReticuleAlphaCurve;
        [NMS(Index = 753)]
        /* 0x8453 */ public TkCurveType CreatureReticuleScaleCurve;
        [NMS(Index = 694)]
        /* 0x8454 */ public TkCurveType CrosshairLeadScaleCurve;
        [NMS(Index = 712)]
        /* 0x8455 */ public TkCurveType CrosshairTargetLockAlphaCurve;
        [NMS(Index = 711)]
        /* 0x8456 */ public TkCurveType CrosshairTargetLockCurve;
        [NMS(Index = 624)]
        /* 0x8457 */ public TkCurveType DamageNumberUpCurve;
        [NMS(Index = 327)]
        /* 0x8458 */ public bool DebugInventoryIndices;
        [NMS(Index = 569)]
        /* 0x8459 */ public bool DebugMarkerLabels;
        [NMS(Index = 324)]
        /* 0x845A */ public bool DebugMissionLogText;
        [NMS(Index = 326)]
        /* 0x845B */ public bool DebugPopupSizes;
        [NMS(Index = 325)]
        /* 0x845C */ public bool DebugShowMaintenanceScreenCentre;
        [NMS(Index = 1433)]
        /* 0x845D */ public bool EnableAccessibleUIOnSwitch;
        [NMS(Index = 455)]
        /* 0x845E */ public bool EnableBlackouts;
        [NMS(Index = 811)]
        /* 0x845F */ public bool EnableBuilderRobotGreekConversion;
        [NMS(Index = 253)]
        /* 0x8460 */ public bool EnableCraftingTree;
        [NMS(Index = 190)]
        /* 0x8461 */ public bool EnableHandMenuButtons;
        [NMS(Index = 222)]
        /* 0x8462 */ public bool EnableHandMenuDebug;
        [NMS(Index = 812)]
        /* 0x8463 */ public bool EnableKanaConversion;
        [NMS(Index = 95)]
        /* 0x8464 */ public bool EnablePopupUses;
        [NMS(Index = 328)]
        /* 0x8465 */ public bool FixedInventoryIconPositions;
        [NMS(Index = 1122)]
        /* 0x8466 */ public TkCurveType FrontendBootBarCurve;
        [NMS(Index = 1107)]
        /* 0x8467 */ public TkCurveType FrontendConfirmCurve;
        [NMS(Index = 1194)]
        /* 0x8468 */ public TkCurveType FrontendDoFCurve;
        [NMS(Index = 886)]
        /* 0x8469 */ public bool HideExtremePlanetNotifications;
        [NMS(Index = 1410)]
        /* 0x846A */ public bool HideQuickMenuControls;
        [NMS(Index = 1343)]
        /* 0x846B */ public TkCurveType HUDMarkerActiveCurve;
        [NMS(Index = 1313)]
        /* 0x846C */ public TkCurveType HUDMarkerAnimAlphaCurve;
        [NMS(Index = 1314)]
        /* 0x846D */ public TkCurveType HUDMarkerAnimCurve;
        [NMS(Index = 844)]
        /* 0x846E */ public TkCurveType HUDPlayerTrackArrowEnergyShieldDepletedCurve;
        [NMS(Index = 849)]
        /* 0x846F */ public TkCurveType HUDPlayerTrackArrowEnergyShieldStartChargeCurve;
        [NMS(Index = 303)]
        /* 0x8470 */ public bool InteractionInWorldPlayerCamAlways;
        [NMS(Index = 987)]
        /* 0x8471 */ public TkCurveType InteractionScanSlapCurve;
        [NMS(Index = 514)]
        /* 0x8472 */ public bool LeadTargetEnabled;
        [NMS(Index = 1014)]
        /* 0x8473 */ public bool ModelRendererBGPass;
        [NMS(Index = 1015)]
        /* 0x8474 */ public bool ModelRendererPass1;
        [NMS(Index = 1016)]
        /* 0x8475 */ public bool ModelRendererPass2;
        [NMS(Index = 1391)]
        /* 0x8476 */ public TkCurveType NGuiModelViewFadeInAfterRenderCurve;
        [NMS(Index = 1392)]
        /* 0x8477 */ public bool NGuiUseSeparateLayersForModelAndReflection;
        [NMS(Index = 210)]
        /* 0x8478 */ public bool OnlyShowEjectHandlesInVR;
        [NMS(Index = 70)]
        /* 0x8479 */ public TkCurveType PadCursorUICurve;
        [NMS(Index = 504)]
        /* 0x847A */ public TkCurveType PageTurnCurve;
        [NMS(Index = 505)]
        /* 0x847B */ public TkCurveType PageTurnFadeCurve;
        [NMS(Index = 1126)]
        /* 0x847C */ public TkCurveType PopupActivateCurve1;
        [NMS(Index = 1127)]
        /* 0x847D */ public TkCurveType PopupActivateCurve2;
        [NMS(Index = 558)]
        /* 0x847E */ public bool ProgressiveDialogStyle;
        [NMS(Index = 1411)]
        /* 0x847F */ public bool QuickMenuAllowCycle;
        [NMS(Index = 254)]
        /* 0x8480 */ public bool QuickMenuEnableSwipe;
        [NMS(Index = 323)]
        /* 0x8481 */ public bool RepairTechUseTechIcon;
        [NMS(Index = 86)]
        /* 0x8482 */ public bool ReplaceItemBarWithNumbers;
        [NMS(Index = 1029)]
        /* 0x8483 */ public bool ShieldHUDAlwaysOn;
        [NMS(Index = 571)]
        /* 0x8484 */ public bool ShowDamageNumbers;
        [NMS(Index = 55)]
        /* 0x8485 */ public bool ShowDifficultyForBases;
        [NMS(Index = 883)]
        /* 0x8486 */ public bool ShowJetpackNotificationForNonTerrain;
        [NMS(Index = 603)]
        /* 0x8487 */ public bool ShowOnscreenPredatorMarkers;
        [NMS(Index = 56)]
        /* 0x8488 */ public bool ShowPadlockForLockedSettings;
        [NMS(Index = 206)]
        /* 0x8489 */ public bool ShowVRDistanceWarning;
        [NMS(Index = 126)]
        /* 0x848A */ public bool SkipShopIntro;
        [NMS(Index = 1237)]
        /* 0x848B */ public TkCurveType SpaceMapDistanceCurve;
        [NMS(Index = 1223)]
        /* 0x848C */ public bool SpaceMapShowAnomaly;
        [NMS(Index = 1224)]
        /* 0x848D */ public bool SpaceMapShowAnomalyLines;
        [NMS(Index = 1230)]
        /* 0x848E */ public bool SpaceMapShowFrieghterLines;
        [NMS(Index = 1229)]
        /* 0x848F */ public bool SpaceMapShowFrieghters;
        [NMS(Index = 1225)]
        /* 0x8490 */ public bool SpaceMapShowNexus;
        [NMS(Index = 1226)]
        /* 0x8491 */ public bool SpaceMapShowNexusLines;
        [NMS(Index = 1220)]
        /* 0x8492 */ public bool SpaceMapShowPlanetLines;
        [NMS(Index = 1219)]
        /* 0x8493 */ public bool SpaceMapShowPlanets;
        [NMS(Index = 1232)]
        /* 0x8494 */ public bool SpaceMapShowPulseEncounterLines;
        [NMS(Index = 1231)]
        /* 0x8495 */ public bool SpaceMapShowPulseEncounters;
        [NMS(Index = 1228)]
        /* 0x8496 */ public bool SpaceMapShowShipLines;
        [NMS(Index = 1227)]
        /* 0x8497 */ public bool SpaceMapShowShips;
        [NMS(Index = 1221)]
        /* 0x8498 */ public bool SpaceMapShowStation;
        [NMS(Index = 1222)]
        /* 0x8499 */ public bool SpaceMapShowStationLines;
        [NMS(Index = 515)]
        /* 0x849A */ public bool SpaceOnlyLeadTargetEnabled;
        [NMS(Index = 96)]
        /* 0x849B */ public bool TechBoxesCanStack;
        [NMS(Index = 765)]
        /* 0x849C */ public TkCurveType TrackCritCurve;
        [NMS(Index = 751)]
        /* 0x849D */ public TkCurveType TrackReticuleInAngleCurve;
        [NMS(Index = 750)]
        /* 0x849E */ public TkCurveType TrackReticuleInCurve;
        [NMS(Index = 1096)]
        /* 0x849F */ public bool UseCursorHoverSlowFixedValue;
        [NMS(Index = 98)]
        /* 0x84A0 */ public bool UseIntermediateMissionGiverOptions;
        [NMS(Index = 817)]
        /* 0x84A1 */ public bool UseNamesOnShipHUD;
        [NMS(Index = 89)]
        /* 0x84A2 */ public bool UseSquareSlots;
        [NMS(Index = 322)]
        /* 0x84A3 */ public bool UseWorldNodesForRepair;
    }
}
