...
{
    [NMS(GUID = 0x5D0265C454CB9402, NameHash = 0xEADD2E75)]
    public class GcGraphicsGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 320, Size = 0x4, EnumType = typeof(TkGraphicsDetailTypes.GraphicDetailEnum))]
        ...
        [NMS(Index = 139)]
        /* 0xF3C */ public bool DOFEnableBokeh;
        [NMS(Index = 140)]
        /* 0xF3D */ public bool DOFEnableNewBokehShader;
        [NMS(Index = 141)]
        /* 0xF3E */ public bool DOFEnablePhysCamera;
        [NMS(Index = 297)]
        /* 0xF3F */ public bool EnableCrossPipeSharing;
        [NMS(Index = 298)]
        /* 0xF40 */ public bool EnableSSR;
        [NMS(Index = 274)]
        /* 0xF41 */ public bool EnableTerrainCachePs4Base;
        [NMS(Index = 275)]
        /* 0xF42 */ public bool EnableTerrainCachePs4Pro;
        [NMS(Index = 276)]
        /* 0xF43 */ public bool EnableTerrainCacheXb1Base;
        [NMS(Index = 277)]
        /* 0xF44 */ public bool EnableTerrainCacheXb1X;
        [NMS(Index = 286)]
        /* 0xF45 */ public bool EnableTextureStreaming;
        [NMS(Index = 319)]
        /* 0xF46 */ public bool EnableVariableUpdate;
        [NMS(Index = 278)]
        /* 0xF47 */ public bool ForceCachedTerrain;
        [NMS(Index = 288)]
        /* 0xF48 */ public bool ForceEvictAllTextures;
        [NMS(Index = 287)]
        /* 0xF49 */ public bool ForceStreamAllTextures;
        [NMS(Index = 279)]
        /* 0xF4A */ public bool ForceUncachedTerrain;
        [NMS(Index = 175)]
        /* 0xF4B */ public bool FullscreenScanEffect;
        [NMS(Index = 329)]
        /* 0xF4C */ public bool IBLReflections;
        [NMS(Index = 15)]
        /* 0xF4D */ public bool Redo_On;
        [NMS(Index = 85)]
        /* 0xF4E */ public bool ShadowQuantized;
        [NMS(Index = 299)]
        /* 0xF4F */ public bool ShowReflectionProbes;
        [NMS(Index = 245)]
        /* 0xF50 */ public bool ShowTaaBuf;
        [NMS(Index = 249)]
        /* 0xF51 */ public bool ShowTaaCVarianceBuf;
        [NMS(Index = 248)]
        /* 0xF52 */ public bool ShowTaaNVarianceBuf;
        [NMS(Index = 247)]
        /* 0xF53 */ public bool ShowTaaVarianceBuf;
        [NMS(Index = 246)]
        /* 0xF54 */ public bool TonemapInLuminance;
        [NMS(Index = 176)]
        /* 0xF55 */ public bool UseImposters;
        [NMS(Index = 243)]
        /* 0xF56 */ public bool UseTaaResolve;
    }
}
