...
namespace libMBIN.NMS.Globals
{
    ...
    public class GcCreatureGlobals : NMSTemplate
    {
        ...
        /* 0x1970 */ public float[] SpherePusherOffset;
        [NMS(Index = 2, Size = 0x4, EnumType = typeof(GcCreatureSizeClasses.CreatureSizeClassEnum))]
        /* 0x1980 */ public float[] SpherePusherRadiusMul;
        [NMS(Index = 1, Size = 0x4, EnumType = typeof(GcCreatureSizeClasses.CreatureSizeClassEnum))]
        /* 0x1990 */ public float[] SpherePusherWeight;
        [NMS(Index = 268)]
        /* 0x19A0 */ public Vector2f JellyBossBroodMaxChaseTime;
        [NMS(Index = 281)]
        ...
        [NMS(Index = 358)]
        /* 0x19F0 */ public float AvoidCreaturesWeight;
        [NMS(Index = 359)]
        /* 0x19F4 */ public float AvoidImpassableWeight;
        [NMS(Index = 344)]
        /* 0x19F8 */ public float BadTurnPercent;
        [NMS(Index = 345)]
        /* 0x19FC */ public float BadTurnWeight;
        [NMS(Index = 360)]
        /* 0x1A00 */ public float BaseAndTerrainModImpassableStrength;
        [NMS(Index = 353)]
        /* 0x1A04 */ public float BrakingForce;
        [NMS(Index = 354)]
        /* 0x1A08 */ public float BrakingForceY;
        [NMS(Index = 291)]
        /* 0x1A0C */ public int BugFiendHealth;
        [NMS(Index = 286)]
        /* 0x1A10 */ public int BugQueenHealth;
        [NMS(Index = 290)]
        /* 0x1A14 */ public float BugQueenSpitballExplosionRadius;
        [NMS(Index = 289)]
        /* 0x1A18 */ public float BugQueenSpitballSpeed;
        [NMS(Index = 287)]
        /* 0x1A1C */ public int BugQueenSpitCount;
        [NMS(Index = 288)]
        /* 0x1A20 */ public float BugQueenSpitRadius;
        [NMS(Index = 190)]
        /* 0x1A24 */ public float CreatureBlobRidingHugeMinSize;
        [NMS(Index = 189)]
        /* 0x1A28 */ public float CreatureBlobRidingLargeMinSize;
        [NMS(Index = 188)]
        ...
        [NMS(Index = 194)]
        /* 0x1A48 */ public int CreatureHugeHealth;
        [NMS(Index = 184)]
        /* 0x1A4C */ public float CreatureHugeMinSize;
        [NMS(Index = 202)]
        ...
        [NMS(Index = 10)]
        /* 0x1A60 */ public float CreatureInteractionRangeBoostHuge;
        [NMS(Index = 11)]
        /* 0x1A64 */ public float CreatureInteractionRangeBoostLarge;
        [NMS(Index = 12)]
        /* 0x1A68 */ public float CreatureInteractionRangeBoostMedium;
        [NMS(Index = 14)]
        /* 0x1A6C */ public float CreatureInteractionRangeBoostRun;
        [NMS(Index = 13)]
        /* 0x1A70 */ public float CreatureInteractionRangeBoostSmall;
        [NMS(Index = 15)]
        ...
        [NMS(Index = 183)]
        /* 0x1A94 */ public float CreatureLargeMinSize;
        [NMS(Index = 198)]
        /* 0x1A98 */ public float CreatureLargeRunMaxShakeDist;
        [NMS(Index = 196)]
        /* 0x1A9C */ public float CreatureLargeWalkMaxShakeDist;
        [NMS(Index = 91)]
        /* 0x1AA0 */ public float CreatureLookBeforeFleeingIfShotTime;
        [NMS(Index = 90)]
        /* 0x1AA4 */ public float CreatureLookBeforeFleeingTime;
        [NMS(Index = 89)]
        /* 0x1AA8 */ public float CreatureLookBeforeGoingTime;
        [NMS(Index = 93)]
        /* 0x1AAC */ public float CreatureLookPlayerForceLookTime;
        [NMS(Index = 92)]
        /* 0x1AB0 */ public float CreatureLookScaryThingTime;
        [NMS(Index = 192)]
        /* 0x1AB4 */ public int CreatureMedHealth;
        [NMS(Index = 182)]
        /* 0x1AB8 */ public float CreatureMedMinSize;
        [NMS(Index = 75)]
        /* 0x1ABC */ public float CreatureMinAlignSpeed;
        [NMS(Index = 88)]
        /* 0x1AC0 */ public float CreatureMinAnimMoveSpeed;
        [NMS(Index = 81)]
        /* 0x1AC4 */ public float CreatureMinRunTime;
        [NMS(Index = 84)]
        /* 0x1AC8 */ public float CreatureMoveIdle;
        [NMS(Index = 187)]
        /* 0x1ACC */ public float CreatureRidingHugeMinSize;
        [NMS(Index = 186)]
        /* 0x1AD0 */ public float CreatureRidingLargeMinSize;
        [NMS(Index = 185)]
        /* 0x1AD4 */ public float CreatureRidingMedMinSize;
        [NMS(Index = 44)]
        /* 0x1AD8 */ public float CreatureScaleMangle;
        [NMS(Index = 83)]
        ...
        [NMS(Index = 369)]
        /* 0x1AF8 */ public float DefaultRunMoveSpeed;
        [NMS(Index = 368)]
        /* 0x1AFC */ public float DefaultTrotMoveSpeed;
        [NMS(Index = 367)]
        /* 0x1B00 */ public float DefaultWalkMoveSpeed;
        [NMS(Index = 242)]
        /* 0x1B04 */ public float DelayAfterRespawnBeforeAttackable;
        [NMS(Index = 406)]
        /* 0x1B08 */ public float DespawnDistFactor;
        [NMS(Index = 416)]
        /* 0x1B0C */ public float DetailAnimBlendInTime;
        [NMS(Index = 417)]
        /* 0x1B10 */ public float DetailAnimBlendOutTime;
        [NMS(Index = 419)]
        /* 0x1B14 */ public float DetailAnimMaxPauseTime;
        [NMS(Index = 418)]
        /* 0x1B18 */ public float DetailAnimMinPauseTime;
        [NMS(Index = 155)]
        /* 0x1B1C */ public float DroneExplodeRadius;
        [NMS(Index = 374)]
        /* 0x1B20 */ public float EdgeClosenessPenalty;
        [NMS(Index = 105)]
        /* 0x1B24 */ public float ExtraFollowFreq1;
        [NMS(Index = 106)]
        /* 0x1B28 */ public float ExtraFollowFreq2;
        [NMS(Index = 104)]
        /* 0x1B2C */ public float ExtraFollowStrength;
        [NMS(Index = 403)]
        /* 0x1B30 */ public float FadeDistance;
        [NMS(Index = 401)]
        /* 0x1B34 */ public float FadeScaleMultiplier;
        [NMS(Index = 402)]
        ...
        [NMS(Index = 313)]
        /* 0x1B54 */ public float FiendAggroIncreaseDamageEgg;
        [NMS(Index = 314)]
        /* 0x1B58 */ public float FiendAggroIncreaseDestroyEgg;
        [NMS(Index = 302)]
        /* 0x1B5C */ public float FiendAggroTime;
        [NMS(Index = 319)]
        /* 0x1B60 */ public float FiendBeingShotMemoryTime;
        [NMS(Index = 316)]
        /* 0x1B64 */ public float FiendCritAreaSize;
        [NMS(Index = 299)]
        /* 0x1B68 */ public float FiendDespawnDistance;
        [NMS(Index = 318)]
        /* 0x1B6C */ public float FiendDistReduceForBeingShot;
        [NMS(Index = 317)]
        /* 0x1B70 */ public float FiendDistToConsiderTargetSwtich;
        [NMS(Index = 308)]
        /* 0x1B74 */ public int FiendEggsToUnlockSpit;
        [NMS(Index = 292)]
        /* 0x1B78 */ public int FiendHealth;
        [NMS(Index = 296)]
        /* 0x1B7C */ public float FiendHealthLevelMul;
        [NMS(Index = 304)]
        /* 0x1B80 */ public int FiendMaxAttackers;
        [NMS(Index = 303)]
        /* 0x1B84 */ public int FiendMaxEngaged;
        [NMS(Index = 312)]
        /* 0x1B88 */ public float FiendMaxSpawnTime;
        [NMS(Index = 305)]
        /* 0x1B8C */ public float FiendMaxVerticalForPounce;
        [NMS(Index = 311)]
        /* 0x1B90 */ public float FiendMinSpawnTime;
        [NMS(Index = 297)]
        /* 0x1B94 */ public float FiendPerceptionDistance;
        [NMS(Index = 285)]
        /* 0x1B98 */ public float FiendPounceDistanceModifier;
        [NMS(Index = 301)]
        /* 0x1B9C */ public float FiendReplicateEndDistance;
        [NMS(Index = 300)]
        /* 0x1BA0 */ public float FiendReplicateStartDistance;
        [NMS(Index = 298)]
        /* 0x1BA4 */ public float FiendSpawnDistance;
        [NMS(Index = 306)]
        /* 0x1BA8 */ public float FiendZigZagSpeed;
        [NMS(Index = 307)]
        /* 0x1BAC */ public float FiendZigZagStrength;
        [NMS(Index = 145)]
        /* 0x1BB0 */ public float FishBobAmplitude;
        [NMS(Index = 144)]
        /* 0x1BB4 */ public float FishBobFrequency;
        [NMS(Index = 384)]
        /* 0x1BB8 */ public float FishDesiredDepth;
        [NMS(Index = 326)]
        /* 0x1BBC */ public float FishFiendBigBoostStrength;
        [NMS(Index = 327)]
        /* 0x1BC0 */ public float FishFiendBigBoostTime;
        [NMS(Index = 322)]
        /* 0x1BC4 */ public int FishFiendBigHealth;
        [NMS(Index = 328)]
        /* 0x1BC8 */ public float FishFiendBigScale;
        [NMS(Index = 323)]
        /* 0x1BCC */ public float FishFiendSmallBoostStrength;
        [NMS(Index = 324)]
        /* 0x1BD0 */ public float FishFiendSmallBoostTime;
        [NMS(Index = 321)]
        /* 0x1BD4 */ public int FishFiendSmallHealth;
        [NMS(Index = 325)]
        /* 0x1BD8 */ public float FishFiendSmallScale;
        [NMS(Index = 385)]
        /* 0x1BDC */ public float FishMinHeightAboveSeaBed;
        [NMS(Index = 387)]
        /* 0x1BE0 */ public float FishObstacleAvoidStrength;
        [NMS(Index = 389)]
        /* 0x1BE4 */ public float FishPlayerAttractionAhead;
        [NMS(Index = 388)]
        /* 0x1BE8 */ public float FishPlayerAttractionFrontDist;
        [NMS(Index = 391)]
        /* 0x1BEC */ public float FishPlayerAttractionMaxDist;
        [NMS(Index = 390)]
        /* 0x1BF0 */ public float FishPlayerAttractionMinDist;
        [NMS(Index = 392)]
        /* 0x1BF4 */ public float FishPlayerAttractionStrength;
        [NMS(Index = 229)]
        /* 0x1BF8 */ public float FishPredatorChargeDist;
        [NMS(Index = 230)]
        /* 0x1BFC */ public float FishPredatorChargeDistScale;
        [NMS(Index = 386)]
        /* 0x1C00 */ public float FishSeaBedAvoidStrength;
        [NMS(Index = 382)]
        /* 0x1C04 */ public float FishWaterSurfaceAnticipate;
        [NMS(Index = 383)]
        /* 0x1C08 */ public float FishWaterSurfaceAvoidStrength;
        [NMS(Index = 393)]
        /* 0x1C0C */ public float FloaterObstacleAvoidStrength;
        [NMS(Index = 394)]
        /* 0x1C10 */ public float FloaterSteeringRayLength;
        [NMS(Index = 395)]
        /* 0x1C14 */ public float FloaterSteeringRaySphereSize;
        [NMS(Index = 396)]
        /* 0x1C18 */ public float FloaterSteeringRaySpread;
        [NMS(Index = 380)]
        /* 0x1C1C */ public float FloaterSurfaceAnticipate;
        [NMS(Index = 381)]
        /* 0x1C20 */ public float FloaterSurfaceAvoidStrength;
        [NMS(Index = 355)]
        /* 0x1C24 */ public float FlowFieldWeight;
        [NMS(Index = 361)]
        ...
        [NMS(Index = 173)]
        /* 0x1C40 */ public float FootDustGroundTintStrength;
        [NMS(Index = 425)]
        /* 0x1C44 */ public float FootParticleTime;
        [NMS(Index = 100)]
        /* 0x1C48 */ public float FootPlantError;
        [NMS(Index = 249)]
        /* 0x1C4C */ public float FreighterDespawnDist;
        [NMS(Index = 147)]
        /* 0x1C50 */ public float FreighterJellyBobAmplitude;
        [NMS(Index = 146)]
        ...
        [NMS(Index = 131)]
        /* 0x1C64 */ public float GroundWormScaleMin;
        [NMS(Index = 130)]
        /* 0x1C68 */ public float GroundWormSpawnChance;
        [NMS(Index = 127)]
        /* 0x1C6C */ public float GroundWormSpawnerActivateRadius;
        [NMS(Index = 128)]
        /* 0x1C70 */ public float GroundWormSpawnerDestroyRadiusActive;
        [NMS(Index = 129)]
        /* 0x1C74 */ public float GroundWormSpawnerDestroyRadiusInactive;
        [NMS(Index = 126)]
        /* 0x1C78 */ public int GroundWormSpawnMax;
        [NMS(Index = 125)]
        /* 0x1C7C */ public int GroundWormSpawnMin;
        [NMS(Index = 122)]
        /* 0x1C80 */ public float GroundWormSpawnRadius;
        [NMS(Index = 123)]
        ...
        [NMS(Index = 349)]
        /* 0x1CD4 */ public float ImpassabilityTurnSpeedMultiplier;
        [NMS(Index = 348)]
        /* 0x1CD8 */ public float ImpassabilityUnbrakeTime;
        [NMS(Index = 244)]
        /* 0x1CDC */ public float IndoorObstacleAvoidStrength;
        [NMS(Index = 245)]
        /* 0x1CE0 */ public float IndoorSteeringRayLength;
        [NMS(Index = 246)]
        /* 0x1CE4 */ public float IndoorSteeringRaySphereSize;
        [NMS(Index = 247)]
        /* 0x1CE8 */ public float IndoorSteeringRaySpread;
        [NMS(Index = 243)]
        /* 0x1CEC */ public float IndoorTurnTime;
        [NMS(Index = 151)]
        /* 0x1CF0 */ public float InfluenceDeflect;
        [NMS(Index = 149)]
        /* 0x1CF4 */ public float InfluenceForce;
        [NMS(Index = 148)]
        /* 0x1CF8 */ public float InfluenceRadius;
        [NMS(Index = 150)]
        /* 0x1CFC */ public float InfluenceThreshold;
        [NMS(Index = 270)]
        /* 0x1D00 */ public float JellyBossBroodColourInterpTime;
        [NMS(Index = 267)]
        /* 0x1D04 */ public float JellyBossBroodSeparateTime;
        [NMS(Index = 266)]
        /* 0x1D08 */ public float JellyBossBroodWarningRadius;
        [NMS(Index = 269)]
        /* 0x1D0C */ public float JellyBossColourInterpTime;
        [NMS(Index = 366)]
        /* 0x1D10 */ public float JellyBossFastSwimSpeed;
        [NMS(Index = 378)]
        /* 0x1D14 */ public float JellyBossLandAnticipate;
        [NMS(Index = 379)]
        /* 0x1D18 */ public float JellyBossLandAvoidStrength;
        [NMS(Index = 213)]
        ...
        [NMS(Index = 59)]
        /* 0x1F7C */ public float PlayerDamageTransferScale;
        [NMS(Index = 232)]
        /* 0x1F80 */ public float PlayerPredatorBoredomDistance;
        [NMS(Index = 223)]
        /* 0x1F84 */ public float PlayerPredatorHealthModifier;
        [NMS(Index = 234)]
        /* 0x1F88 */ public float PlayerPredatorRegainInterestTime;
        [NMS(Index = 51)]
        /* 0x1F8C */ public float PostRideMoveTime;
        [NMS(Index = 224)]
        /* 0x1F90 */ public float PredatorApproachTime;
        [NMS(Index = 231)]
        /* 0x1F94 */ public float PredatorBoredomDistance;
        [NMS(Index = 227)]
        /* 0x1F98 */ public float PredatorChargeDist;
        [NMS(Index = 228)]
        /* 0x1F9C */ public float PredatorChargeDistScale;
        [NMS(Index = 239)]
        /* 0x1FA0 */ public float PredatorEnergyRecoverRate;
        [NMS(Index = 240)]
        /* 0x1FA4 */ public float PredatorEnergyUseChasing;
        [NMS(Index = 215)]
        /* 0x1FA8 */ public float PredatorFishPerceptionDistance;
        [NMS(Index = 222)]
        /* 0x1FAC */ public int PredatorHugeHealth;
        [NMS(Index = 221)]
        /* 0x1FB0 */ public int PredatorLargeHealth;
        [NMS(Index = 220)]
        /* 0x1FB4 */ public int PredatorMedHealth;
        [NMS(Index = 225)]
        /* 0x1FB8 */ public float PredatorNoticePauseTime;
        [NMS(Index = 214)]
        /* 0x1FBC */ public float PredatorPerceptionDistance;
        [NMS(Index = 233)]
        /* 0x1FC0 */ public float PredatorRegainInterestTime;
        [NMS(Index = 236)]
        /* 0x1FC4 */ public float PredatorRoarProbAfterHit;
        [NMS(Index = 237)]
        /* 0x1FC8 */ public float PredatorRoarProbAfterMiss;
        [NMS(Index = 235)]
        /* 0x1FCC */ public float PredatorRunAwayDist;
        [NMS(Index = 238)]
        /* 0x1FD0 */ public float PredatorRunAwayHealthPercent;
        [NMS(Index = 372)]
        ...
        [NMS(Index = 371)]
        /* 0x1FE4 */ public float PredatorTrotMoveSpeed;
        [NMS(Index = 370)]
        /* 0x1FE8 */ public float PredatorWalkMoveSpeed;
        [NMS(Index = 295)]
        /* 0x1FEC */ public float QueenHealthLevelMul;
        [NMS(Index = 335)]
        /* 0x1FF0 */ public float RagdollConeLimit;
        [NMS(Index = 334)]
        /* 0x1FF4 */ public float RagdollDamping;
        [NMS(Index = 338)]
        /* 0x1FF8 */ public float RagdollMotorFadeEnd;
        [NMS(Index = 337)]
        /* 0x1FFC */ public float RagdollMotorFadeStart;
        [NMS(Index = 333)]
        /* 0x2000 */ public float RagdollTau;
        [NMS(Index = 336)]
        /* 0x2004 */ public float RagdollTwistLimit;
        [NMS(Index = 101)]
        /* 0x2008 */ public float RecoverHealthTime;
        [NMS(Index = 3)]
        /* 0x200C */ public float RemoteSpawnFadeInDelay;
        [NMS(Index = 165)]
        /* 0x2010 */ public float RepelAmount;
        [NMS(Index = 164)]
        /* 0x2014 */ public float RepelRange;
        [NMS(Index = 68)]
        /* 0x2018 */ public float ResourceSpawnTime;
        [NMS(Index = 52)]
        /* 0x201C */ public float RideIdleTime;
        [NMS(Index = 50)]
        /* 0x2020 */ public float RiderLeanTime;
        [NMS(Index = 49)]
        /* 0x2024 */ public float RideSpeedChangeTime;
        [NMS(Index = 48)]
        /* 0x2028 */ public float RideSpeedFast;
        [NMS(Index = 47)]
        /* 0x202C */ public float RideSpeedSlow;
        [NMS(Index = 42)]
        /* 0x2030 */ public float RidingFirstPersonOffsetFwd;
        [NMS(Index = 43)]
        /* 0x2034 */ public float RidingFirstPersonOffsetUp;
        [NMS(Index = 39)]
        /* 0x2038 */ public float RidingReplicationRangeMultiplier;
        [NMS(Index = 40)]
        /* 0x203C */ public float RidingRollAdjustMaxAngle;
        [NMS(Index = 41)]
        ...
        [NMS(Index = 331)]
        /* 0x2050 */ public float RoutineSpeed;
        [NMS(Index = 107)]
        /* 0x2054 */ public float SandWormChangeDirectionTime;
        [NMS(Index = 117)]
        /* 0x2058 */ public float SandWormDespawnDist;
        [NMS(Index = 111)]
        /* 0x205C */ public float SandWormJumpHeight;
        [NMS(Index = 112)]
        /* 0x2060 */ public float SandWormJumpTime;
        [NMS(Index = 110)]
        /* 0x2064 */ public float SandWormMaxHeightAdjust;
        [NMS(Index = 116)]
        /* 0x2068 */ public int SandWormMaxJumps;
        [NMS(Index = 109)]
        /* 0x206C */ public float SandWormMaxSteer;
        [NMS(Index = 121)]
        /* 0x2070 */ public float SandWormSpawnChanceInfested;
        [NMS(Index = 120)]
        /* 0x2074 */ public float SandWormSpawnChanceMax;
        [NMS(Index = 119)]
        /* 0x2078 */ public float SandWormSpawnChanceMin;
        [NMS(Index = 118)]
        /* 0x207C */ public float SandWormSpawnTimer;
        [NMS(Index = 108)]
        /* 0x2080 */ public float SandWormSteerAdjustTime;
        [NMS(Index = 113)]
        /* 0x2084 */ public float SandWormSubmergeDepth;
        [NMS(Index = 114)]
        /* 0x2088 */ public float SandWormSubmergeTime;
        [NMS(Index = 115)]
        /* 0x208C */ public float SandWormSurfaceTime;
        [NMS(Index = 74)]
        /* 0x2090 */ public float SceneTerrainSpawnMinDistance;
        [NMS(Index = 251)]
        /* 0x2094 */ public int ScuttlerHealth;
        [NMS(Index = 256)]
        /* 0x2098 */ public float ScuttlerIdleTimeMax;
        [NMS(Index = 255)]
        /* 0x209C */ public float ScuttlerIdleTimeMin;
        [NMS(Index = 252)]
        /* 0x20A0 */ public float ScuttlerInitialNoAttackTime;
        [NMS(Index = 254)]
        /* 0x20A4 */ public float ScuttlerMoveTimeMax;
        [NMS(Index = 253)]
        /* 0x20A8 */ public float ScuttlerMoveTimeMin;
        [NMS(Index = 261)]
        /* 0x20AC */ public float ScuttlerSpitChargeTime;
        [NMS(Index = 260)]
        /* 0x20B0 */ public float ScuttlerSpitDelay;
        [NMS(Index = 259)]
        /* 0x20B4 */ public float ScuttlerZigZagStrength;
        [NMS(Index = 258)]
        ...
        [NMS(Index = 134)]
        /* 0x20DC */ public float SharkAlongPathSpeed;
        [NMS(Index = 138)]
        /* 0x20E0 */ public float SharkAttackAccel;
        [NMS(Index = 137)]
        /* 0x20E4 */ public float SharkAttackSpeed;
        [NMS(Index = 142)]
        /* 0x20E8 */ public float SharkGetToPathSpeed;
        [NMS(Index = 141)]
        /* 0x20EC */ public float SharkPatrolEnd;
        [NMS(Index = 140)]
        /* 0x20F0 */ public float SharkPatrolRadius;
        [NMS(Index = 139)]
        /* 0x20F4 */ public float SharkPatrolSpeed;
        [NMS(Index = 136)]
        /* 0x20F8 */ public float SharkToPathYDamp;
        [NMS(Index = 133)]
        /* 0x20FC */ public float ShieldFadeTime;
        [NMS(Index = 212)]
        /* 0x2100 */ public float SmallCreatureAvoidPlayerDistance;
        [NMS(Index = 210)]
        /* 0x2104 */ public float SmallCreatureFleePlayerDistance;
        [NMS(Index = 208)]
        /* 0x2108 */ public float SmallCreaturePerceptionDistance;
        [NMS(Index = 363)]
        /* 0x210C */ public float SoftenAvoidanceRadiusMod;
        [NMS(Index = 398)]
        /* 0x2110 */ public float SpawnCameraAngleCos;
        [NMS(Index = 172)]
        /* 0x2114 */ public float SpawnDistanceModifierForUnderwater;
        [NMS(Index = 405)]
        /* 0x2118 */ public float SpawnDistAtMaxSize;
        [NMS(Index = 404)]
        /* 0x211C */ public float SpawnDistAtMinSize;
        [NMS(Index = 399)]
        /* 0x2120 */ public float SpawnMinDistPercentage;
        [NMS(Index = 400)]
        /* 0x2124 */ public float SpawnOnscreenDist;
        [NMS(Index = 410)]
        /* 0x2128 */ public float SpawnsAvoidBaseMultiplier;
        [NMS(Index = 293)]
        /* 0x212C */ public int SpookBossHealth;
        [NMS(Index = 271)]
        /* 0x2130 */ public float SpookFiendColourInterpTime;
        [NMS(Index = 365)]
        /* 0x2134 */ public float SpookFiendFastSwimSpeed;
        [NMS(Index = 294)]
        /* 0x2138 */ public int SpookSquidHealth;
        [NMS(Index = 376)]
        /* 0x213C */ public float SteeringUpdateRate;
        [NMS(Index = 175)]
        /* 0x2140 */ public float StickToGroundCastBegin;
        [NMS(Index = 176)]
