...
{
    [NMS(GUID = 0x53C3DD48D80E3B68, NameHash = 0xFC6CA276)]
    public class GcPlayerGlobals : NMSTemplate
    {
        ...
        [NMS(Index = 222)]
        /* 0x1758 */ public float RespawnOnPadRadius;
        [NMS(Index = 234)]
        /* 0x175C */ public int RobotMultiplierWithFriends;
        [NMS(Index = 341)]
        /* 0x1760 */ public float RocketBootsActivationWindow;
        [NMS(Index = 344)]
        /* 0x1764 */ public float RocketBootsBoostForce;
        [NMS(Index = 357)]
        /* 0x1768 */ public float RocketBootsBoostOffTime;
        [NMS(Index = 356)]
        /* 0x176C */ public float RocketBootsBoostOnTime;
        [NMS(Index = 354)]
        /* 0x1770 */ public float RocketBootsBoostTankDrainSpeed;
        [NMS(Index = 342)]
        /* 0x1774 */ public float RocketBootsDoubleTapTime;
        [NMS(Index = 363)]
        /* 0x1778 */ public float RocketBootsDriftBraking;
        [NMS(Index = 364)]
        /* 0x177C */ public float RocketBootsDriftDownwardForce;
        [NMS(Index = 361)]
        /* 0x1780 */ public float RocketBootsDriftEndTime;
        [NMS(Index = 345)]
        /* 0x1784 */ public float RocketBootsDriftForce;
        [NMS(Index = 355)]
        /* 0x1788 */ public float RocketBootsDriftTankDrainSpeed;
        [NMS(Index = 347)]
        /* 0x178C */ public float RocketBootsForceDuration;
        [NMS(Index = 346)]
        /* 0x1790 */ public float RocketBootsForceStartTime;
        [NMS(Index = 352)]
        /* 0x1794 */ public float RocketBootsHeightAdjustDownStrength;
        [NMS(Index = 350)]
        /* 0x1798 */ public float RocketBootsHeightAdjustTime;
        [NMS(Index = 351)]
        /* 0x179C */ public float RocketBootsHeightAdjustUpStrength;
        [NMS(Index = 343)]
        /* 0x17A0 */ public float RocketBootsImpulse;
        [NMS(Index = 353)]
        /* 0x17A4 */ public float RocketBootsJetpackMinLevel;
        [NMS(Index = 349)]
        /* 0x17A8 */ public float RocketBootsMaxDesiredHeight;
        [NMS(Index = 360)]
        /* 0x17AC */ public float RocketBootsMaxSpeed;
        [NMS(Index = 348)]
        /* 0x17B0 */ public float RocketBootsMinDesiredHeight;
        [NMS(Index = 362)]
        /* 0x17B4 */ public float RocketBootsWindUpBraking;
        [NMS(Index = 359)]
        /* 0x17B8 */ public float RocketBootsZigZagForceDuration;
        [NMS(Index = 358)]
        /* 0x17BC */ public float RocketBootsZigZagStrength;
        [NMS(Index = 603)]
        /* 0x17C0 */ public float ScanBeamMainWidth;
        [NMS(Index = 601)]
        /* 0x17C4 */ public float ScanBeamWidth;
        [NMS(Index = 599)]
        /* 0x17C8 */ public float ScanFadeInTime;
        [NMS(Index = 600)]
        /* 0x17CC */ public float ScanFadeOutTime;
        [NMS(Index = 591)]
        /* 0x17D0 */ public float ScanLabelTime;
        [NMS(Index = 596)]
        /* 0x17D4 */ public float ScanRotate;
        [NMS(Index = 602)]
        /* 0x17D8 */ public float ScanRotateBeamWdith;
        [NMS(Index = 597)]
        /* 0x17DC */ public float ScanRotateDist;
        [NMS(Index = 598)]
        /* 0x17E0 */ public float ScanRotateWobbleAmp;
        [NMS(Index = 593)]
        /* 0x17E4 */ public float ScanWobbleAmp;
        [NMS(Index = 595)]
        /* 0x17E8 */ public float ScanWobbleAmp2;
        [NMS(Index = 592)]
        /* 0x17EC */ public float ScanWobbleFreq;
        [NMS(Index = 594)]
        /* 0x17F0 */ public float ScanWobbleFreq2;
        [NMS(Index = 867)]
        /* 0x17F4 */ public int ShieldMaximum;
        [NMS(Index = 541)]
        /* 0x17F8 */ public float ShieldRechargeMinTimeSinceDamage;
        [NMS(Index = 542)]
        /* 0x17FC */ public float ShieldRechargeRate;
        [NMS(Index = 869)]
        /* 0x1800 */ public float ShieldRestoreDelay;
        [NMS(Index = 868)]
        /* 0x1804 */ public float ShieldRestoreSpeed;
        [NMS(Index = 865)]
        /* 0x1808 */ public float ShipCameraLag;
        [NMS(Index = 435)]
        /* 0x180C */ public float ShipCoolFactor;
        [NMS(Index = 432)]
        /* 0x1810 */ public float ShipPriceExp2;
        [NMS(Index = 236)]
        /* 0x1814 */ public float ShipSummonLastSafeMargin;
        [NMS(Index = 790)]
        /* 0x1818 */ public float ShootOffset;
        [NMS(Index = 791)]
        /* 0x181C */ public float ShootPrepTime;
        [NMS(Index = 789)]
        /* 0x1820 */ public float ShootSizeBase;
        [NMS(Index = 787)]
        /* 0x1824 */ public float ShootSizeMaxXY;
        [NMS(Index = 785)]
        /* 0x1828 */ public float ShootSizeMaxZ;
        [NMS(Index = 786)]
        /* 0x182C */ public float ShootSizeMinXY;
        [NMS(Index = 784)]
        /* 0x1830 */ public float ShootSizeMinZ;
        [NMS(Index = 788)]
        /* 0x1834 */ public float ShootSizeTime;
        [NMS(Index = 646)]
        /* 0x1838 */ public float ShotgunDispersion;
        [NMS(Index = 587)]
        /* 0x183C */ public float SleepFadeTime;
        [NMS(Index = 833)]
        /* 0x1840 */ public float SlopeSlideBrake;
        [NMS(Index = 832)]
        /* 0x1844 */ public float SlopeSlidingSpeed;
        [NMS(Index = 327)]
        /* 0x1848 */ public float SolarRegenFactor;
        [NMS(Index = 400)]
        /* 0x184C */ public float SpaceJetpackDrainRate;
        [NMS(Index = 396)]
        /* 0x1850 */ public float SpaceJetpackForce;
        [NMS(Index = 398)]
        /* 0x1854 */ public float SpaceJetpackIgnitionForce;
        [NMS(Index = 399)]
        /* 0x1858 */ public float SpaceJetpackMaxSpeed;
        [NMS(Index = 397)]
        /* 0x185C */ public float SpaceJetpackUpForce;
        [NMS(Index = 781)]
        /* 0x1860 */ public float SpaceMaxGravityDist;
        [NMS(Index = 782)]
        /* 0x1864 */ public float SpaceMinGravityDist;
        [NMS(Index = 212)]
        /* 0x1868 */ public float SpacewalkBrake;
        [NMS(Index = 211)]
        /* 0x186C */ public float SpacewalkForce;
        [NMS(Index = 214)]
        /* 0x1870 */ public float SpacewalkJetpackForce;
        [NMS(Index = 215)]
        /* 0x1874 */ public float SpacewalkJetpackUpForce;
        [NMS(Index = 213)]
        /* 0x1878 */ public float SpacewalkMaxSpeed;
        [NMS(Index = 216)]
        /* 0x187C */ public float SpacewalkSurfaceHeight;
        [NMS(Index = 245)]
        /* 0x1880 */ public float SpawningDistanceBetweenPlayersAfterWarp;
        [NMS(Index = 246)]
        /* 0x1884 */ public float SpawningSpaceBattleLookOffset;
        [NMS(Index = 247)]
        /* 0x1888 */ public float SpawningSpaceBattleLookOffsetUp;
        [NMS(Index = 576)]
        /* 0x188C */ public float SpeedLinesLength;
        [NMS(Index = 585)]
        /* 0x1890 */ public float SpeedLinesMaxAlpha;
        [NMS(Index = 584)]
        /* 0x1894 */ public float SpeedLinesMinAlpha;
        [NMS(Index = 586)]
        /* 0x1898 */ public float SpeedLinesOffset;
        [NMS(Index = 582)]
        /* 0x189C */ public float SpeedLinesRadiusIncrement;
        [NMS(Index = 581)]
        /* 0x18A0 */ public float SpeedLinesRadiusStartMax;
        [NMS(Index = 580)]
        /* 0x18A4 */ public float SpeedLinesRadiusStartMin;
        [NMS(Index = 575)]
        /* 0x18A8 */ public float SpeedLinesSpeedMax;
        [NMS(Index = 574)]
        /* 0x18AC */ public float SpeedLinesSpeedMin;
        [NMS(Index = 583)]
        /* 0x18B0 */ public float SpeedLinesStartFade;
        [NMS(Index = 577)]
        /* 0x18B4 */ public float SpeedLinesTotalLength;
        [NMS(Index = 579)]
        /* 0x18B8 */ public float SpeedLinesWidthMax;
        [NMS(Index = 578)]
        /* 0x18BC */ public float SpeedLinesWidthMin;
        [NMS(Index = 588)]
        /* 0x18C0 */ public float StaminaRate;
        [NMS(Index = 590)]
        /* 0x18C4 */ public float StaminaRecoveredFactor;
        [NMS(Index = 589)]
        /* 0x18C8 */ public float StaminaRecoveryRate;
        [NMS(Index = 572)]
        /* 0x18CC */ public float StarFieldDensity;
        [NMS(Index = 571)]
        /* 0x18D0 */ public float StarFieldRadius;
        [NMS(Index = 573)]
        /* 0x18D4 */ public float StarFieldStarSize;
        [NMS(Index = 409)]
        /* 0x18D8 */ public float StartHazardTimeMultiplier;
        [NMS(Index = 410)]
        /* 0x18DC */ public float StartSpookTimeMultiplier;
        [NMS(Index = 368)]
        /* 0x18E0 */ public int StealthBaseCharge;
        [NMS(Index = 366)]
        /* 0x18E4 */ public float StealthDrainRate;
        [NMS(Index = 365)]
        /* 0x18E8 */ public float StealthMinLevel;
        [NMS(Index = 367)]
        /* 0x18EC */ public float StealthRechargeRate;
        [NMS(Index = 725)]
        /* 0x18F0 */ public float StickDeadZoneMax;
        [NMS(Index = 724)]
        /* 0x18F4 */ public float StickDeadZoneMin;
        [NMS(Index = 88)]
        /* 0x18F8 */ public float StickYDampingThreshold;
        [NMS(Index = 487)]
        /* 0x18FC */ public int SuitInventoryStartSeed;
        [NMS(Index = 23)]
        /* 0x1900 */ public float SummonArcRange;
        [NMS(Index = 118)]
        /* 0x1904 */ public float SummonShipDirectionChangeDeadZoneAngle;
        [NMS(Index = 210)]
        /* 0x1908 */ public float SurfaceSwimForce;
        [NMS(Index = 207)]
        /* 0x190C */ public float SurfaceSwimMaxSpeed;
        [NMS(Index = 799)]
        /* 0x1910 */ public float TakeDamageImpulse;
        [NMS(Index = 810)]
        /* 0x1914 */ public float TargetDistance;
        [NMS(Index = 811)]
        /* 0x1918 */ public float TargetRadius;
        [NMS(Index = 11)]
        /* 0x191C */ public float TeleportAppearEffectSpeed;
        [NMS(Index = 128)]
        /* 0x1920 */ public float TeleportArcLengthMultiplier;
        [NMS(Index = 119)]
        /* 0x1924 */ public float TeleportArcRadius;
        [NMS(Index = 120)]
        /* 0x1928 */ public float TeleportArcRadiusInner;
        [NMS(Index = 59)]
        /* 0x192C */ public float TeleportBallCompletionFactorFadeout;
        [NMS(Index = 56)]
        /* 0x1930 */ public float TeleportBallDistanceFadeAlpha;
        [NMS(Index = 54)]
        /* 0x1934 */ public float TeleportBallFadeMinDistance;
        [NMS(Index = 55)]
        /* 0x1938 */ public float TeleportBallFadeRange;
        [NMS(Index = 57)]
        /* 0x193C */ public float TeleportBallRadius;
        [NMS(Index = 130)]
        /* 0x1940 */ public float TeleportBeamAnimHeight;
        [NMS(Index = 129)]
        /* 0x1944 */ public float TeleportBeamAnimSpeed;
        [NMS(Index = 126)]
        /* 0x1948 */ public float TeleportBeamGravity;
        [NMS(Index = 127)]
        /* 0x194C */ public float TeleportBeamGravityMax;
        [NMS(Index = 53)]
        /* 0x1950 */ public float TeleportChargeFadeInTime;
        [NMS(Index = 50)]
        /* 0x1954 */ public float TeleportChargeMaxDistance;
        [NMS(Index = 49)]
        /* 0x1958 */ public float TeleportChargeMinDistance;
        [NMS(Index = 52)]
        /* 0x195C */ public float TeleportChargeMinTime;
        [NMS(Index = 51)]
        /* 0x1960 */ public float TeleportChargeMoveSpeed;
        [NMS(Index = 168)]
        /* 0x1964 */ public float TeleportDirectionAltHandRange;
        [NMS(Index = 12)]
        /* 0x1968 */ public float TeleportDisappearEffectSpeed;
        [NMS(Index = 124)]
        /* 0x196C */ public float TeleportHmdMaxFade;
        [NMS(Index = 123)]
        /* 0x1970 */ public float TeleportHmdMinFade;
        [NMS(Index = 125)]
        /* 0x1974 */ public float TeleportHmdOutFactor;
        [NMS(Index = 136)]
        /* 0x1978 */ public float TeleportInitiateThreshold;
        [NMS(Index = 167)]
        /* 0x197C */ public float TeleportInstantTravelDistance;
        [NMS(Index = 131)]
        /* 0x1980 */ public float TeleportLastKnownThreshold;
        [NMS(Index = 139)]
        /* 0x1984 */ public float TeleportLineBezierDistanceFactor;
        [NMS(Index = 138)]
        /* 0x1988 */ public float TeleportLineBezierOffset;
        [NMS(Index = 133)]
        /* 0x198C */ public float TeleportLineEndFadeEnd;
        [NMS(Index = 132)]
        /* 0x1990 */ public float TeleportLineEndFadeStart;
        [NMS(Index = 135)]
        /* 0x1994 */ public float TeleportLineFadeRange;
        [NMS(Index = 134)]
        /* 0x1998 */ public float TeleportLineFadeStart;
        [NMS(Index = 47)]
        /* 0x199C */ public float TeleportMaxTravelDistance;
        [NMS(Index = 48)]
        /* 0x19A0 */ public float TeleportMaxTravelDistanceVertical;
        [NMS(Index = 169)]
        /* 0x19A4 */ public float TeleportMotionOffsetAmount;
        [NMS(Index = 170)]
        /* 0x19A8 */ public float TeleportMotionOffsetUp;
        [NMS(Index = 121)]
        /* 0x19AC */ public float TeleportStrafeDistance;
        [NMS(Index = 171)]
        /* 0x19B0 */ public float TeleportTotalTime;
        [NMS(Index = 58)]
        /* 0x19B4 */ public float TeleportTravelSurfaceAngle;
        [NMS(Index = 569)]
        /* 0x19B8 */ public float TemperatureDisplaySampleTime;
        [NMS(Index = 912)]
        /* 0x19BC */ public float TerrainLaserRange;
        [NMS(Index = 641)]
        /* 0x19C0 */ public float ThirdPersonRecoilMultiplier;
        [NMS(Index = 21)]
        /* 0x19C4 */ public float ThirdPersonWeaponAttachRotationCorrectionAngle;
        [NMS(Index = 22)]
        /* 0x19C8 */ public float ThirdPersonWeaponXOffset;
        [NMS(Index = 870)]
        /* 0x19CC */ public float TimeHoldDownAccelerateToLaunchFromOutpost;
        [NMS(Index = 256)]
        /* 0x19D0 */ public float TrackArrowStaticTargetOffsetMultiplier;
        [NMS(Index = 516)]
        /* 0x19D4 */ public float TraderApproachDistance;
        [NMS(Index = 514)]
        /* 0x19D8 */ public float TraderApproachTime;
        [NMS(Index = 530)]
        /* 0x19DC */ public int TraderCommunicationBanMaxTime;
        [NMS(Index = 529)]
        /* 0x19E0 */ public int TraderCommunicationBanMinTime;
        [NMS(Index = 515)]
        /* 0x19E4 */ public float TraderHailDistance;
        [NMS(Index = 513)]
        /* 0x19E8 */ public float TraderHailTime;
        [NMS(Index = 528)]
        /* 0x19EC */ public float TraderHealthFightThreshold;
        [NMS(Index = 517)]
        /* 0x19F0 */ public float TraderSpamTimeWait;
        [NMS(Index = 518)]
        /* 0x19F4 */ public float TraderStayCloseLockOffset;
        [NMS(Index = 519)]
        /* 0x19F8 */ public float TraderStayCloseLockSin1Coeff;
        [NMS(Index = 520)]
        /* 0x19FC */ public float TraderStayCloseLockSin1Offset;
        [NMS(Index = 521)]
        /* 0x1A00 */ public float TraderStayCloseLockSin2Coeff;
        [NMS(Index = 522)]
        /* 0x1A04 */ public float TraderStayCloseLockSin2Offset;
        [NMS(Index = 523)]
        /* 0x1A08 */ public float TraderStayCloseLockSinsAdd;
        [NMS(Index = 524)]
        /* 0x1A0C */ public float TraderStayCloseLockSpread;
        [NMS(Index = 525)]
        /* 0x1A10 */ public float TraderStayCloseLockSpreadAdd;
        [NMS(Index = 526)]
        /* 0x1A14 */ public float TraderStayCloseLockSpreadTime;
        [NMS(Index = 221)]
        /* 0x1A18 */ public float UnderwaterBrake;
        [NMS(Index = 200)]
        /* 0x1A1C */ public float UnderwaterCurrentStrengthHorizontalMax;
        [NMS(Index = 199)]
        /* 0x1A20 */ public float UnderwaterCurrentStrengthHorizontalMin;
        [NMS(Index = 201)]
        /* 0x1A24 */ public float UnderwaterCurrentStrengthVertical;
        [NMS(Index = 197)]
        /* 0x1A28 */ public float UnderwaterFloatRange;
        [NMS(Index = 189)]
        /* 0x1A2C */ public float UnderwaterFluidDensity;
        [NMS(Index = 209)]
        /* 0x1A30 */ public float UnderwaterForce;
        [NMS(Index = 206)]
        /* 0x1A34 */ public float UnderwaterImpact;
        [NMS(Index = 220)]
        /* 0x1A38 */ public float UnderwaterJetpackEscapeForce;
        [NMS(Index = 218)]
        /* 0x1A3C */ public float UnderwaterJetpackForce;
        [NMS(Index = 186)]
        /* 0x1A40 */ public float UnderwaterMargin;
        [NMS(Index = 219)]
        /* 0x1A44 */ public float UnderwaterMaxJetpackEscapeSpeed;
        [NMS(Index = 217)]
        /* 0x1A48 */ public float UnderwaterMaxJetpackSpeed;
        [NMS(Index = 203)]
        /* 0x1A4C */ public float UnderwaterMaxSpeedTotal;
        [NMS(Index = 202)]
        /* 0x1A50 */ public float UnderwaterMaxSpeedTotalJetpacking;
        [NMS(Index = 187)]
        /* 0x1A54 */ public float UnderwaterMinDepth;
        [NMS(Index = 188)]
        /* 0x1A58 */ public float UnderwaterPlayerMass;
        [NMS(Index = 193)]
        /* 0x1A5C */ public float UnderwaterPlayerSphereDepthOffsetFirstPerson;
        [NMS(Index = 196)]
        /* 0x1A60 */ public float UnderwaterPlayerSphereDepthOffsetMax;
        [NMS(Index = 195)]
        /* 0x1A64 */ public float UnderwaterPlayerSphereDepthOffsetMin;
        [NMS(Index = 194)]
        /* 0x1A68 */ public float UnderwaterPlayerSphereDepthOffsetPitchedExtra;
        [NMS(Index = 192)]
        /* 0x1A6C */ public float UnderwaterPlayerSphereOffsetMaxPitch;
        [NMS(Index = 191)]
        /* 0x1A70 */ public float UnderwaterPlayerSphereOffsetMinPitch;
        [NMS(Index = 190)]
        /* 0x1A74 */ public float UnderwaterPlayerSphereRadius;
        [NMS(Index = 204)]
        /* 0x1A78 */ public float UnderwaterSurfaceForceFlattenAngleMin;
        [NMS(Index = 205)]
        /* 0x1A7C */ public float UnderwaterSurfaceForceFlattenAngleRange;
        [NMS(Index = 208)]
        /* 0x1A80 */ public float UnderwaterSwimMaxSpeed;
        [NMS(Index = 908)]
        /* 0x1A84 */ public float UtilityWeaponRange;
        [NMS(Index = 421)]
        /* 0x1A88 */ public float VehicleHazardDampingModifier;
        [NMS(Index = 913)]
        /* 0x1A8C */ public float VehicleLaserRange;
        [NMS(Index = 263)]
        /* 0x1A90 */ public float VehicleRaceResultsHintTime;
        [NMS(Index = 406)]
        /* 0x1A94 */ public float VRModeHazardTimeMultiplier;
        [NMS(Index = 407)]
        /* 0x1A98 */ public float VRStartHazardTimeMultiplier;
        [NMS(Index = 479)]
        /* 0x1A9C */ public float WalkerAlertRange;
        [NMS(Index = 481)]
        /* 0x1AA0 */ public float WalkerSightAngle;
        [NMS(Index = 480)]
        /* 0x1AA4 */ public float WalkerSightRange;
        [NMS(Index = 604)]
        /* 0x1AA8 */ public float WantedDroneEventRadius;
        [NMS(Index = 722)]
        /* 0x1AAC */ public float WantedEnemyAttackAmount;
        [NMS(Index = 607)]
        /* 0x1AB0 */ public float WantedLevelDelay;
        [NMS(Index = 265)]
        /* 0x1AB4 */ public float WantedLevelPlayerRange;
        [NMS(Index = 266)]
        /* 0x1AB8 */ public float WantedLevelPlayerRangeSpace;
        [NMS(Index = 610)]
        /* 0x1ABC */ public float WantedMinorCrimeAmount;
        [NMS(Index = 606)]
        /* 0x1AC0 */ public float WantedMinPlanetTime;
        [NMS(Index = 605)]
        /* 0x1AC4 */ public float WantedMinSpaceTime;
        [NMS(Index = 611)]
        /* 0x1AC8 */ public float WantedTimeoutAggressive;
        [NMS(Index = 609)]
        /* 0x1ACC */ public float WantedWitnessFuzzyTime;
        [NMS(Index = 608)]
        /* 0x1AD0 */ public float WantedWitnessTimer;
        [NMS(Index = 771)]
        /* 0x1AD4 */ public float WeaponBobBlendTime;
        [NMS(Index = 770)]
        /* 0x1AD8 */ public float WeaponBobFactorRun;
        [NMS(Index = 769)]
        /* 0x1ADC */ public float WeaponBobFactorWalk;
        [NMS(Index = 768)]
        /* 0x1AE0 */ public float WeaponBobFactorWalkDeadZone;
        [NMS(Index = 774)]
        /* 0x1AE4 */ public float WeaponCannonMinUnchargedShotThreshold;
        [NMS(Index = 775)]
        /* 0x1AE8 */ public float WeaponCannonMinUnchargedShotTime;
        [NMS(Index = 773)]
        /* 0x1AEC */ public float WeaponCannonMinWeaponTimer;
        [NMS(Index = 762)]
        /* 0x1AF0 */ public float WeaponChangeModeTime;
        [NMS(Index = 436)]
        /* 0x1AF4 */ public float WeaponCoolFactor;
        [NMS(Index = 776)]
        /* 0x1AF8 */ public float WeaponGrenadeTime;
        [NMS(Index = 777)]
        /* 0x1AFC */ public float WeaponGunTime;
        [NMS(Index = 766)]
        /* 0x1B00 */ public float WeaponHolsterDelay;
        [NMS(Index = 767)]
        /* 0x1B04 */ public float WeaponLag;
        [NMS(Index = 765)]
        /* 0x1B08 */ public float WeaponLowerDelay;
        [NMS(Index = 433)]
        /* 0x1B0C */ public float WeaponPriceExp2;
        [NMS(Index = 778)]
        /* 0x1B10 */ public float WeaponRailFireTime;
        [NMS(Index = 779)]
        /* 0x1B14 */ public float WeaponRailRechargeTime;
        [NMS(Index = 314)]
        /* 0x1B18 */ public float WeaponShotgunSlowdown;
        [NMS(Index = 286)]
        /* 0x1B1C */ public float WeaponZoomFOV;
        [NMS(Index = 291)]
        /* 0x1B20 */ public float WeaponZoomHorzRotation;
        [NMS(Index = 289)]
        /* 0x1B24 */ public float WeaponZoomRecoilMultiplier;
        [NMS(Index = 290)]
        /* 0x1B28 */ public float WeaponZoomVertRotation;
        [NMS(Index = 546)]
        /* 0x1B2C */ public float WitnessAIDamageAngle;
        [NMS(Index = 545)]
        /* 0x1B30 */ public float WitnessAIDamageDistance;
        [NMS(Index = 258)]
        /* 0x1B34 */ public float WitnessSenseEnhancement;
        [NMS(Index = 257)]
        /* 0x1B38 */ public float WitnessSenseEnhancementTime;
        [NMS(Index = 150)]
        /* 0x1B3C */ public int WordCategoriesRequiredToConverse;
        [NMS(Index = 476)]
        /* 0x1B40 */ public float WoundDamageDecayTime;
        [NMS(Index = 474)]
        /* 0x1B44 */ public float WoundDamageLimit;
        [NMS(Index = 475)]
        /* 0x1B48 */ public float WoundDamageLimitShip;
        [NMS(Index = 473)]
        /* 0x1B4C */ public float WoundTimeMinimum;
        [NMS(Index = 680)]
        /* 0x1B50 */ public TkCurveType AimDisperseCurve;
        [NMS(Index = 657)]
        /* 0x1B51 */ public bool AutoAim;
        [NMS(Index = 668)]
        /* 0x1B52 */ public TkCurveType AutoAimCentreOffsetCurve;
        [NMS(Index = 667)]
        /* 0x1B53 */ public TkCurveType AutoAimDotCurve;
        [NMS(Index = 644)]
        /* 0x1B54 */ public bool BoltcasterHasTracer;
        [NMS(Index = 402)]
        /* 0x1B55 */ public bool ClampPitch;
        [NMS(Index = 240)]
        /* 0x1B56 */ public bool CreatureRideFade;
        [NMS(Index = 87)]
        /* 0x1B57 */ public bool DoPlayerAppearInVehicleEffect;
        [NMS(Index = 401)]
        /* 0x1B58 */ public bool EnableHeadMovements;
        [NMS(Index = 98)]
        /* 0x1B59 */ public bool EnableLeaning;
        [NMS(Index = 99)]
        /* 0x1B5A */ public bool EnablePointDownToSmoothMove;
        [NMS(Index = 283)]
        /* 0x1B5B */ public bool FireButtonReloadsWeapon;
        [NMS(Index = 3)]
        /* 0x1B5C */ public bool ForceFreighterProcTechRandom;
        [NMS(Index = 292)]
        /* 0x1B5D */ public bool FrontShieldEnabled;
        [NMS(Index = 163)]
        /* 0x1B5E */ public bool HandSwimEnabled;
        [NMS(Index = 463)]
        /* 0x1B5F */ public bool HideHazardPanel;
        [NMS(Index = 100)]
        /* 0x1B60 */ public bool HmdSmoothTurnAlways;
        [NMS(Index = 92)]
        /* 0x1B61 */ public bool InteractNearbyRadiusEnabled;
        [NMS(Index = 464)]
        /* 0x1B62 */ public bool InventoryDamage;
        [NMS(Index = 468)]
        /* 0x1B63 */ public bool LuckyWithTech;
        [NMS(Index = 438)]
        /* 0x1B64 */ public bool MouseCrosshairVisible;
        [NMS(Index = 456)]
        /* 0x1B65 */ public TkCurveType MouseFlightCurve;
        [NMS(Index = 248)]
        /* 0x1B66 */ public bool MultiplayerShareWanted;
        [NMS(Index = 465)]
        /* 0x1B67 */ public bool NeverPreyedOn;
        [NMS(Index = 94)]
        /* 0x1B68 */ public bool PassiveLook;
        [NMS(Index = 467)]
        /* 0x1B69 */ public bool PermanantAltFire;
        [NMS(Index = 466)]
        /* 0x1B6A */ public bool PermanantFire;
        [NMS(Index = 15)]
        /* 0x1B6B */ public bool RecenterViewWhenEnteringShip;
        [NMS(Index = 249)]
        /* 0x1B6C */ public bool ReportAllProjectileDamage;
        [NMS(Index = 89)]
        /* 0x1B6D */ public bool RequireHandsOnShipControls;
        [NMS(Index = 339)]
        /* 0x1B6E */ public bool RocketBootsEnabled;
        [NMS(Index = 340)]
        /* 0x1B6F */ public bool RocketBootsUseCustomCamera;
        [NMS(Index = 90)]
        /* 0x1B70 */ public bool ShowFirstPersonCharacterShadowPCVR;
        [NMS(Index = 91)]
        /* 0x1B71 */ public bool ShowFirstPersonCharacterShadowPSVR;
        [NMS(Index = 284)]
        /* 0x1B72 */ public bool ShowLowAmmoWarning;
        [NMS(Index = 726)]
        /* 0x1B73 */ public TkCurveType StickCurve;
        [NMS(Index = 137)]
        /* 0x1B74 */ public bool TeleportRecentre;
        [NMS(Index = 198)]
        /* 0x1B75 */ public TkCurveType UnderwaterBuoyancyDepthCurve;
        [NMS(Index = 485)]
        /* 0x1B76 */ public bool UpgradeExosuitWithProduct;
        [NMS(Index = 461)]
        /* 0x1B77 */ public bool UseEnergy;
        [NMS(Index = 462)]
        /* 0x1B78 */ public bool UseHazardProtection;
        [NMS(Index = 254)]
        /* 0x1B79 */ public bool UseLargeHealthBar;
        [NMS(Index = 772)]
        /* 0x1B7A */ public TkCurveType WeaponBobBlendCurve;
        [NMS(Index = 285)]
        /* 0x1B7B */ public bool WeaponZoomEnabled;
    }
}
