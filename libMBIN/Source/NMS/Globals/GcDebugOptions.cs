...
{
    [NMS(GUID = 0xB74CAC6170752696, NameHash = 0xAA861200)]
    public class GcDebugOptions : NMSTemplate
    {
        ...
        [NMS(Index = 184, MxmlName = "3dTextDistance")]
        /* 0x06AC */ public float _3dTextDistance;
        [NMS(Index = 185, MxmlName = "3dTextMinScale")]
        ...
        [NMS(Index = 126)]
        /* 0x2250 */ public bool UseGTAO;
        [NMS(Index = 30)]
        /* 0x2251 */ public bool UseGunImpactEffect;
        [NMS(Index = 169)]
        /* 0x2252 */ public bool UseHighlightedOptionStyle;
        [NMS(Index = 88)]
        /* 0x2253 */ public bool UseImmediateModeFrontend;
        [NMS(Index = 129)]
        /* 0x2254 */ public bool UseInstances;
        [NMS(Index = 135)]
        /* 0x2255 */ public bool UseLegacyBuildingTable;
        [NMS(Index = 134)]
        /* 0x2256 */ public bool UseLegacyFreighters;
        [NMS(Index = 86)]
        /* 0x2257 */ public bool UseMovementStickForRun;
        [NMS(Index = 130)]
        /* 0x2258 */ public bool UseObjects;
        [NMS(Index = 395)]
        /* 0x2259 */ public bool UseOldTerrainMeshing;
        [NMS(Index = 289)]
        /* 0x225A */ public bool UsePadOnUnfocusedWindow;
        [NMS(Index = 122)]
        /* 0x225B */ public bool UseParticles;
        [NMS(Index = 311)]
        /* 0x225C */ public bool UseProcTextureDebugger;
        [NMS(Index = 119)]
        /* 0x225D */ public bool UseSceneInfoWindow;
        [NMS(Index = 29)]
        /* 0x225E */ public bool UseScreenEffects;
        [NMS(Index = 436)]
        /* 0x225F */ public bool UseSeasonTransferInventoryConfigOverride;
        [NMS(Index = 128)]
        /* 0x2260 */ public bool UseTerrain;
        [NMS(Index = 123)]
        /* 0x2261 */ public bool UseVolumetrics;
        [NMS(Index = 14)]
        /* 0x2262 */ public bool VideoCaptureMode;
    }
}
