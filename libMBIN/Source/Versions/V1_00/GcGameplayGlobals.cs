...
namespace libMBIN.V1_00.Structs
{
    public class GcGameplayGlobals : NMSTemplate
    {
        ...
        public int UnknownC8a;
        public int UnknownC8b;
        ...
        public int Unknown110; // the file has an int here; the exe-parsed string starts at 0x114
        [NMS(Size = 0x1C)]
        public string Unknown114;     // offset: 272, sz: 32, origin:  "Hr"        // line:   strncpy((char *)(a1 + 272), "Hr", 0x20ui64);
        // line:   *(_BYTE *)(v1 + 303) = 0;
        public int Unknown130;
        [NMS(Size = 0x1C)]
        public string Unknown134;     // offset: 304, sz: 32, origin:  "Ch"        // line:   strncpy((char *)(v1 + 304), "Ch", 0x20ui64);
        // line:   *(_BYTE *)(v1 + 335) = 0;
        ...
        public float Unknown1B4; // the file holds 1.8f here, not a bool     // offset: 436, sz: 1, origin: 1, parsed: 1        // line:   *(_BYTE *)(v1 + 436) = 1;
        ...
        public int UnknownExtraA; public int UnknownExtraB; public int UnknownExtraC;
        ...
        public int Unknown268a;
        public int Unknown268b;
        ...
        public int UnknownExtraD; public int UnknownExtraE;
     ...
     // offset: 1124, sz: 4, origin: 1050253722, parsed: 0.3        // line:   *(_DWORD *)(v1 + 1124) = 1050253722;
        ...
        public float UnknownA44; public float UnknownA48; // was a long, but 0xA44 is unaligned: the long drifted +4 and swallowed the B0C string head     // offset: 2628, sz: 8, origin: 0i64, parsed: 0. comment: either a long or two floats        // line:   *(_QWORD *)(v1 + 2628) = 0i64;
        ...
        [NMS(Size = 0x80)]
        public string UnknownB0C; // plain string: NMSString0x80 would align to 0xB10 and swallow UnknownB8C     // offset: 2828, sz: 128, origin:  "MODELS/PLANETS/BIOMES/COMMON/BUILDINGS/DISTRESSSIGNAL/DISTRESSSCENE.DAE"        // line:   result = strncpy((char *)(v1 + 2828), "MODELS/PLANETS/BIOMES/COMMON/BUILDINGS/DISTRESSSIGNAL/DISTRESSSCENE.DAE", 0x80ui64);
